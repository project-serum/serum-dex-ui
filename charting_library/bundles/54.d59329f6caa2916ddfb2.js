        ...
        constructor(e) {
          super(e),
            (this._setValue = (e, t, n) => {
              ...
              i.logNormal(
                `Changing property "${e}" value from "${s.value()}" to "${t}"`,
              ),
        ...
        componentDidMount() {
          ...
          e.childNames().forEach((t) => {
            Object(o.ensureDefined)(e.child(t)).subscribe(this, (e) => {
              const n = e.value();
              i.logNormal(`Property "${t}" updated to value "${n}"`),
                this.setState({ [t]: n });
            });
          });
        }
        ...
        return i.a.createElement(
          c.a,
          {
            ...
            onChange: function (e) {
              S(e),
                'main-symbol' === e
                  ? Object(b.b)(_)('', n.id, n.name)
                  : j && j.current && j.current.updateSymbol();
            },
          },
          i.a.createElement(
            l.a.Row,
        ...
        return T(t)
          ? T((n = t)) && 'inline' === n.groupType
            ...
            : r.createElement(
                ...
                r.createElement(
                  'div',
                  { className: N.titleWrap },
                  r.createElement(S.a, { title: t.id, name: t.id }),
                ),
                t.children.map((e) =>
                  T(e)
                      ...
                      if (void 0 !== o)
                        if (void 0 !== r)
                          if (n.has(o)) {
                            ...
                            let i;
                            s.has(t)
                              ? (i = Object(d.ensureDefined)(s.get(t)))
                              : ((i = new Map()), s.set(t, i)),
      ...
      function r(e, t) {
        return s.createElement(o.Consumer, null, (n) =>
          n
            ? s.createElement(
                e,
                Object.assign({}, Object.assign({ model: n }, t)),
              )
            : null,
        );
      }
    ...
    PjdP: function (e, t, n) {
      ...
      class k extends s.PureComponent {
        render() {
              ...
              .forEach((e) => {
                ...
                if (1 === i.length) o[n + '$0'] = t;
                  ...
                  const e = i.reduce((e, s, o) => {
                    ...
                    let i;
                    try {
                      i = Object(g.ensureDefined)(
                        Object(g.ensureDefined)(r)[s.id],
                      ).title;
                    } catch (a) {
                      i = s.id;
                    }
          ...
          return s.createElement(
            x.a,
            Object.assign({}, this.props, { input: i }),
          );
        }
        _isStudy(e) {
      ...
      class M extends s.PureComponent {
        ...
        render() {
          ...
          let a = r.value();
          const c = D
              ? D.get().filter((e) => !R.Interval.parse(e).isRange())
              : [],
      ...
      class z extends s.PureComponent {
        render() {
          return s.createElement(T.b.Consumer, null, (e) =>
      ...
      class v extends o.a.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._onBlur = (e) => {
              this.setState({
                displayValue: y(this.props, this.props.value),
                focused: !1,
              }),
            ...
            (this._onValueByStepChange = (e) => {
              ...
              this._checkValueBoundaries(r).value &&
                (this.setState({ displayValue: y(this.props, r) }),
    ...
    XDrA: function (e, t, n) {
      ...
      function l(e) {
        ...
        return o.a.createElement(
          'div',
          { className: r(a.inputGroup, n && a.inlineGroup, t) },
          e.children,
        );
      }
    },
        ...
        return Object(o.b)(
          ({ model: n }) =>
            s.createElement(
              ...
              s.createElement(e, Object.assign({}, t)),
            ),
          t,
        );
      }
    ...
    fV01: function (e, t, n) {
      ...
      class y extends o.a.PureComponent {
        constructor(e) {
          ...
          (this._adapter = Object(f.a)(t)),
            (this.state = { value: n || '', expanded: !1 });
        }
        componentDidMount() {
          const e = this.context || Object(c.getRootOverlapManager)();
          Object(d.symbolSearchUIService)().bindToInput(
            Object(a.ensureNotNull)(this._input),
            {
              ...
              onPopupOpen: (t) => {
                (this._popup = e.ensureWindow(this._uuid)),
                  this.setState({ expanded: !0 }),
                  t.appendTo(this._popup);
              },
              onPopupClose: () => {
                (this._popup = null),
      ...
      const C = Object(b.a)(function (e) {
        ...
        return o.a.createElement(
          y,
          Object.assign({}, e, { value: v(i || r || '', n), study: n }),
        );
      });
    },
    h5Dg: function (e, t, n) {
          ...
          super(...arguments),
            ...
            (this._onColorChange = (e) => {
              ...
              s &&
                ...
                this._setProperty(
                  t,
                  Object(i.generateColor)(String(e), o, !0),
                  h,
                ),
    ...
    qzWo: function (e, t, n) {
      ...
      function d(e) {
        ...
        return o.a.createElement(a.a, {
          icon: u,
          className: i()('apply-common-tooltip', c.icon),
          title: t,
          onClick: h,
        });
      }
