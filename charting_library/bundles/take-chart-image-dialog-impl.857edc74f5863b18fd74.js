  ...
  ['take-chart-image-dialog-impl'],
  {
      ...
      class l extends s.PureComponent {
        ...
        render() {
          const {
            ...
            h = this.props.style
              ? Object.assign(
                  Object.assign({}, this._createStyles()),
                  this.props.style,
                )
              : this._createStyles();
    ...
    AVTG: function (e, t, n) {
      ...
      function d(e) {
        return s.createElement(
          'div',
          { className: r(l.body, e.className), ref: e.reference },
          e.children,
        );
      }
      var u = n('8Rai'),
      ...
      class c extends s.PureComponent {
        ...
        _manager() {
          return null === this.context
            ? Object(i.getRootOverlapManager)()
            : this.context;
        }
      }
      c.contextType = a.b;
    ...
    fMMV: function (e, t, n) {
      ...
      async function i(e, t, n, s = {}) {
        ...
        if (void 0 !== s.previews)
          for (const r of s.previews) a.append('previews[]', r);
        ...
        'exchange' === u &&
          (u =
            (null === (i = l.model().mainSeries().symbolInfo()) || void 0 === i
              ? void 0
              : i.timezone) || u),
          a.append('timezone', u),
          a.append(
            'images',
            JSON.stringify(e.images(), (e, t) =>
              t instanceof HTMLCanvasElement ? null : t,
            ),
          ),
          (async function (e, t, n, s = {}) {
            const a = r.enabled('charting_library_base')
              ...
              : '/snapshot/';
            try {
              const s = await Object(o.fetch)(a, {
                  body: e,
                  method: 'POST',
      ...
      class W extends c.Component {
        ...
        componentDidUpdate(e) {
          !e.imageUrl &&
            ...
            setTimeout(() => {
              null !== this._input &&
                (this._input.select(), this._input.focus());
            });
        }
        render() {
                ...
                c.createElement(
                  ...
                  c.createElement(
                    ...
                    c.createElement(
                      'div',
                      {
                        ref: (e) => e && this._setupClipboard(e),
      ...
      function B(e, t = {}, n) {
        ...
        function d(e) {
          o ||
            ...
            l.render(c.createElement(W, e), o);
        }
        function u() {
          d({ isOpened: !1 });
        }
        ...
        return class extends s.PureComponent {
          render() {
            ...
            const o = s.createElement(
              e,
              Object.assign({}, this.props, { zIndex: 150 }),
            );
