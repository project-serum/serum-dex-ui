!(function (e) {
  function a(a) {
    for (
      ...
      (b = o[n]),
        Object.prototype.hasOwnProperty.call(t, b) && t[b] && l.push(t[b][0]),
        (t[b] = 0);
  ...
  function d() {
    for (var e, a = 0; a < f.length; a++) {
      for (var d = f[a], c = !0, b = 1; b < d.length; b++) {
        var r = d[b];
        0 !== t[r] && (c = !1);
      }
      c && (f.splice(a--, 1), (e = o((o.s = d[0]))));
    }
    return e;
  }
  var c = {},
        ...
        a.push(
          (b[e] = new Promise(function (a, d) {
            for (
              ...
              var i =
                (l = f[r]).getAttribute('data-href') || l.getAttribute('href');
              if ('stylesheet' === l.rel && (i === c || i === t)) return a();
            }
            var n = document.getElementsByTagName('style');
            for (r = 0; r < n.length; r++) {
              var l;
              if ((i = (l = n[r]).getAttribute('data-href')) === c || i === t)
                return a();
            }
