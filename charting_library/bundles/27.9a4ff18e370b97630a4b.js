          ...
          o.createElement(
            ...
            Object.assign({}, T, {
              ...
              endSlot: o.createElement(
                o.Fragment,
                null,
                x.icon && o.createElement(i.b, { icon: !0 }, x.icon),
                u,
              ),
            }),
          ),
    ...
    jh7f: function (t, e, r) {
      ...
      class p extends s.PureComponent {
        render() {
          const {
            ...
            i = t.map((t, e) =>
              s.createElement('div', { className: g.error, key: e }, t),
            );
          let h = {
            position: 'absolute',
            top: this.props.top,
      ...
      function W(t) {
        const {
          ...
          { attachment: l, targetAttachment: m, attachmentOffsetY: g } =
            null != n ? n : R[s];
      ...
      function F(t) {
        ...
        const {
          ...
          z =
            F || j
              ? o.a.createElement(O, { intent: F ? 'danger' : 'warning' })
              : void 0,
          C = A
            ? o.a.createElement(W, {
                errorAttachment: m,
          ...
          D =
            null !==
              (r = null !== (e = null != C ? C : B) && void 0 !== e ? e : I) &&
            void 0 !== r
              ? r
              : N;
        return Object.assign(
          Object.assign(
            { icon: z, renderedErrors: D, containerReference: E, intent: P },
            w,
          ),
          v,
        );
