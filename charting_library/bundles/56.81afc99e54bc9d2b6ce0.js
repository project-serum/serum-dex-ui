        ...
        return i.a.createElement(
          'div',
          {
            ...
            onMouseDown: function (e) {
              ...
              const i = n - t;
              let r =
                D(e.nativeEvent, Object(l.ensureNotNull)(O.current)) -
                E.current;
              r < 0
                ? ((r = 0),
                  (E.current = D(
                    e.nativeEvent,
                    Object(l.ensureNotNull)(O.current),
                  )))
                : r > i * C * S &&
                  ((r = i * C * S),
                  (E.current =
                    D(e.nativeEvent, Object(l.ensureNotNull)(O.current)) - r));
              d(r / C / S), w(!0);
            },
          },
          i.a.createElement(
            ...
            i.a.createElement('div', {
              className: c()(b.barInner, v && b['barInner--horizontal']),
            }),
          ),
        );
        function x(e) {
      ...
      function b(e) {
        ...
        return r.a.createElement(
          ...
          Object.assign({}, L, {
            ...
            role: n,
            'aria-selected': o,
            className: c(f, B.item, p && B.withIcon, {
              [B.isActive]: j,
              [B.isDisabled]: w || C,
              [B.hovered]: E,
            }),
          ...
          void 0 !== x &&
            r.a.createElement(
              'div',
              { onClick: v, className: c(B.toolbox, { [B.showOnHover]: S }) },
              x,
            ),
        );
        var z;
        ...
        return r.a.createElement(
          ...
          r.a.createElement(
            ...
            r.a.createElement(
              'div',
              {
                className: l()(f.title, h && !g && f.active, p && f.mobile),
            ...
            r.a.createElement(
              'div',
              { className: l()(f.details, h && !g && f.active, p && f.mobile) },
              i,
            ),
          ),
    ...
    n9z6: function (e, t, n) {
      ...
      function a(e, t = c.CheckMobile.any()) {
        const n = Object(o.useRef)(null),
          ...
          [f, d] = Object(o.useState)({
            ...
            onVerticalChange: function (e) {
              d((t) =>
                Object.assign(Object.assign({}, t), { scrollPosTop: e }),
              ),
                (Object(i.ensureNotNull)(a.current).scrollTop = e);
            },
            onHorizontalChange: function (e) {
              d((t) =>
                Object.assign(Object.assign({}, t), { scrollPosLeft: e }),
              ),
        ...
        return (
          Object(o.useEffect)(() => {
            s && v(),
              d((e) => Object.assign(Object.assign({}, e), { visible: s }));
          }, [s]),
          Object(o.useEffect)(
            () => (
