    ...
    SIoL: function (e, t, s) {
      ...
      function r(e, t = {}) {
        const s = Object.assign({}, c, t),
          ...
          p = (function (e, t, s, l) {
            const c = Object(n.ensureNotNull)(
                void 0 !== s ? e.indexOf(s, !0) : e.firstIndex(),
              ),
              r = Object(n.ensureNotNull)(
        ...
        s.includeSeries &&
          (l.schema.push(d('open')),
          l.schema.push(d('high')),
          l.schema.push(d('low')),
          l.schema.push(d('close')));
        ...
        if (s.includeTime)
          for (let o = m; o <= w; ++o)
            l.data[o - m][0] = Object(n.ensureNotNull)(r.valueAt(o));
        if (s.includeUserTime) {
          const t = e.timeScale();
          for (let e = m; e <= w; ++e)
            l.data[e - m][b] =
              Object(n.ensureNotNull)(t.indexToUserTime(e)).getTime() / 1e3;
        }
        if (s.includeSeries) {
          u.bars()
            .range(m, w)
