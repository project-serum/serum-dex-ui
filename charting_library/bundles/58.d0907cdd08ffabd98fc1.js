      ...
      (function (e, i) {
        ...
        var d = {
          ...
          _constrainDraggableOptionsIfNeeded: function (t) {
            return (
              e.enabled('constraint_dialogs_movement') &&
          ...
          showNotice: function (t, e, o) {
            ...
            var a = (o = o || {}).doNotCloseOnBgClick || !1,
              ...
              s = o.width || '400px',
              l = {};
            (l.noClose = o.noClose || null),
              (l.addClass = o.modalDialogClass || null),
          ...
          createModalDialog: function (t, e) {
            (e = e || {}),
              ...
              e.width &&
                d.modalDialog.find('._tv-dialog').css({ width: e.width }),
              e.content &&
                d.modalDialog.find('._tv-dialog-content').html(e.content);
          ...
          createDialog: function (t, e) {
            ...
            var u = {
              start: function (t, e) {
                for (
                  var o = e.helper.css('z-index'), i = 0, a = null, n = 0;
                  n < d.dialogs.length;
                  n++
                ) {
            ...
            return (
              e.dragHandle
                ? (u.handle = e.dragHandle)
                : e.hideTitle || (u.handle = '._tv-dialog-title'),
          ...
          positionDialog: function (t, e, o) {
            ...
            if (((e = e || o.position), t)) {
              ...
              if (e && e.top && e.left)
                (n = o.forcePosition
                  ? e.left
                  : Math.max(2, Math.min(g - r - 4, e.left)) + 'px'),
                  (a = o.forcePosition
                    ? e.top
          ...
          applyHandlers: function (t, e) {
            var o = !t || t === this.modalDialog,
              ...
              a = (t = t || d.modalDialog.find('._tv-dialog')).prop(
                'ownerDocument',
              );
            e.beforeDestroy && t.on('destroy', e.beforeDestroy),
              t
                ...
                .on('click', function (t) {
                  e.closeHandler && 'function' == typeof e.closeHandler
                    ? e.closeHandler(t)
                    : i();
                }),
              ...
              e.processEnterButton &&
                $(a).bind('keyup.confirmAndCloseDialog', function (t) {
                  13 === t.keyCode &&
                    ...
                    (e.processEnterButton.click(),
                    $(a).unbind('keyup.confirmAndCloseDialog'));
                });
          },
          ...
          showMessage: function (t, e, o) {
            ...
            o.html ? n.html('string' == typeof o.html ? o.html : t) : n.text(t),
              n
                .css('width', e.width())
                .toggleClass('selectable', Boolean(o.selectable)),
              a
          ...
          isOpen: function (t) {
            for (var e = 0; e < d.dialogs.length; e++)
              if (d.dialogs[e].title === t) return !0;
            return !1;
          },
          get: function (t) {
            for (var e = 0; e < d.dialogs.length; e++)
              if (d.dialogs[e].title === t) return d.dialogs[e].dialog;
          },
