  ...
  ['header-toolbar'],
  {
    ...
    '1TxM': function (e, t, a) {
      ...
      function c(e) {
        ...
        return l(a, t), i.a.createElement(o.Provider, { value: a }, e.children);
      }
      function d() {
        return o;
      }
    ...
    KMbc: function (e, t, a) {
      ...
      class S extends s.PureComponent {
        ...
        render() {
          ...
          return s.createElement(
            ...
            s.createElement('div', { className: y.wrap }, e),
          );
        }
      }
      var _ = a('tU7i'),
      ...
      function E(e) {
        return s.createElement(
          _.b,
          Object.assign({}, e, { forceInteractive: !0, icon: C }),
        );
      }
      a('YFKU');
      var M = a('Iivm'),
        w = a('a+Yp'),
        I = a('6oLA');
      const O = { text: window.t('View Only Mode') };
      function k(e) {
        return s.createElement(
          'div',
          { className: w.wrap },
          s.createElement(M.a, { className: w.icon, icon: I }),
          O.text,
        );
      }
      var x,
      ...
      class N extends s.PureComponent {
        constructor(e, t) {
          super(e, t),
            (this._handleMouseOver = (e) => {
              Object(V.a)(e) && this.setState({ isHovered: !0 });
            }),
            (this._handleMouseOut = (e) => {
              Object(V.a)(e) && this.setState({ isHovered: !1 });
            }),
            ...
            Object(W.c)(t, { tools: v.any.isRequired }),
        ...
        render() {
          const { tools: e } = this.context,
            ...
            { isHovered: b, mode: g, isAuthenticated: y } = this.state,
            _ = this._processCustoms(c),
            C = this._processCustoms(d),
            M = h.includes(a);
          return s.createElement(
            'div',
            { className: o(L.inner, { [L.fake]: v }), onContextMenu: R.b },
            s.createElement(
              m,
              {
      ...
      class X extends j.a {
        ...
        _deserialize(e) {
          return H()(
            Object(D.convertResolutionsFromSettings)(e)
              .filter(D.isResolutionMultiplierValid)
              .map(D.normalizeIntervalString),
          );
        }
      }
      var G = a('Vdly'),
      ...
      class J {
        ...
        add(e, t, a) {
          ...
          return this._isIntervalDefault(i) || n.includes(i)
            ? null
            : (this._customIntervalsService.set(
                Object(D.sortResolutions)([...n, i]),
              ),
              i);
        }
        remove(e) {
        ...
        _getMaxResolutionValue(e) {
          return q.Interval.isMinuteHours(e)
            ? Math.floor(Object(D.getMaxResolutionValue)('1') / 60)
            : Object(D.getMaxResolutionValue)(e);
        }
      ...
      class oe {
        constructor(e = G) {
          (this._favorites = []),
            (this._favoritesChanged = new ie.a()),
            (this._settings = e),
            U.TVXWindowEvents.on('StudyFavoritesChanged', (e) => {
        ...
        favId(e) {
          return Object(ae.isPineIdString)(e)
            ? e
            : Object(ae.extractPineId)(e) || Object(te.extractStudyId)(e);
        }
        favorites() {
      ...
      function be(e = []) {
        return Object(D.mergeResolutions)(
          e,
          h.enabled('star_some_intervals_by_default') ? me : [],
        );
      }
      new X(U.TVXWindowEvents, G, be()),
        new z(U.TVXWindowEvents, G, pe()),
        new ue.FavoriteStudyTemplateService(U.TVXWindowEvents, G);
      const ge = {
      ...
      class Se extends s.PureComponent {
        constructor(e) {
          super(e),
            (this._saveLoadSyncEmitter = new c.a()),
          ...
          (this._showScrollbarWhen = Object(n.ensureDefined)(
            e.allowedModes,
          ).slice(-1)),
          ...
          this._favoriteChartStylesService =
            u || new z(U.TVXWindowEvents, G, S);
          const _ = be(this.props.defaultFavoriteIntervals);
          (this._favoriteIntervalsService =
            l || new X(U.TVXWindowEvents, G, _)),
            (this._intervalsMenuViewStateService = new he(
              U.TVXWindowEvents,
              G,
            )),
            (this._intervalService = new J(i)),
            (this._registry = {
              tools: t,
              isFundamental: o,
              chartWidgetCollection: s,
            ...
            (this._features = {
              ...
              allowSymbolSearchSpread:
                h.enabled('header_symbol_search') &&
                h.enabled('show_spread_operators'),
              allowToolbarHiding: h.enabled('collapsible_header'),
            }),
            (this._setDisplayMode = Object(d.default)(
        ...
        render() {
          const e = this.props,
            { resizerBridge: t, allowedModes: a } = e,
          ...
          return s.createElement(
            W.a,
            { value: this._registry, validation: ge },
            s.createElement(
              b,
              null,
              s.createElement(
                'div',
                {
                  className: o(fe.toolbar, { [fe.isHidden]: !d }),
        ...
        addButton(e = 'left') {
          const t = new A.a(0),
            ...
            s = { key: Number(new Date()), element: a, width: t },
            { leftCustomButtons: i, rightCustomButtons: n } = this.state;
          return (
            'left' === e
              ? this.setState({ leftCustomButtons: [...i, s] })
              : this.setState({ rightCustomButtons: [...n, s] }),
            a
          );
        }
        _negotiateResizer() {
          this.props.resizerBridge.negotiateHeight(
            this.state.isVisible ? ee.b : ee.a,
          );
        }
        _setDisplayMode() {
          ...
          let i = s.map((e) => a[e]).findIndex((t) => e >= t);
          -1 === i && (i = s.length - 1);
          const r = s[i];
      ...
      const l = o,
        c = i.forwardRef((e, t) => {
          const {
            ...
            C = n(f, g.button, b && 'apply-common-tooltip', {
              [g.isActive]: l,
              [g.isOpened]: c,
            ...
            E =
              a &&
              ('string' == typeof a
                ? i.createElement(r.a, { className: g.icon, icon: a })
                : i.cloneElement(a, {
