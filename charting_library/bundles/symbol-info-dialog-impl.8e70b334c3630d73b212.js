      ...
      (function (e, i) {
        ...
        function S(e) {
          return void 0 === e.minmov || void 0 === e.pricescale
            ? null
            : p(e).format(e.minmov / e.pricescale);
        }
        function T(e) {
        ...
        function H(e) {
          r ||
            ...
            l.render(d.createElement(c, e), r);
        }
        function x(e) {
    ...
    AVTG: function (e, t, n) {
      ...
      function u(e) {
        ...
        return i.createElement(
          'div',
          {
            className: r(o.header, e.className),
            'data-dragg-area': !0,
            ref: e.reference,
          },
          e.children,
      ...
      function l(e) {
        return i.createElement(
          'div',
          { className: r(d.body, e.className), ref: e.reference },
          e.children,
        );
      }
      var c = n('8Rai'),
      ...
      (function (e) {
        e.exports = (function () {
          ...
          function b(e) {
            ...
            return (function (e) {
              for (var t, n, i, r, o = 0; o < e.length; ) {
                for (
                  t = (r = g(e[o]).split('-')).length,
                    n = (n = g(e[o + 1])) ? n.split('-') : null;
                  t > 0;
          ...
          function C(e, t) {
            return function (n) {
              return null != n
                ? (W(this, e, n), i.updateOffset(this, t), this)
                : P(this, e);
            };
          }
          function P(e, t) {
          ...
          function G(e, t) {
            ...
            for (z.lastIndex = 0; n >= 0 && z.test(e); )
              (e = e.replace(z, i)), (z.lastIndex = 0), (n -= 1);
            return e;
          }
          var J = /\d/,
            R = /\d\d/,
          ...
          var Me = /^\s*(?:[+-]\d{6}|\d{4})-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,
            De = [
          ...
          function Ce(e) {
            if (e._f !== i.ISO_8601) {
              ...
              var t,
                ...
                l = 0;
              for (
                r = G(e._f, e._locale).match(N) || [], t = 0;
                t < r.length;
                t++
              )
                (o = r[t]),
            ...
            return (
              je(e)
                ...
                : 'object' == typeof d &&
                  ...
                  o.isBefore(s)
                    ? (u = Xe(o, s))
                    : (((u = Xe(s, o)).milliseconds = -u.milliseconds),
                      (u.months = -u.months)),
          ...
          var dt = 'Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday'.split(
              '_',
            ),
              ...
              var n = e || Ee(),
                ...
                o =
                  r < -6
                    ...
                    : 'sameElse';
              return this.format(
                (t && t[o]) || this.localeData().calendar(o, this, Ee(n)),
              );
            }),
            (Dt.clone = function () {
              return new f(this);
            ...
            (Dt.parseZone = function () {
              return (
                this._tzm
                  ...
                  : 'string' == typeof this._i && this.utcOffset(Ge(this._i)),
                this
              );
            }),
            (Dt.hasAlignedHourOffset = function (e) {
              return (
                (e = e ? Ee(e).utcOffset() : 0),
