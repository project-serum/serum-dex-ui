      ...
      function m(e) {
        ...
        return a.a.createElement(
          ...
          Object.assign({}, M, {
            ...
            role: n,
            'aria-selected': s,
            className: r(h, T.item, w && T.withIcon, {
              [T.isActive]: D,
              [T.isDisabled]: C || O,
              [T.hovered]: _,
            }),
            ...
            onMouseUp: function (t) {
              ...
              if (1 === t.button && y && n) {
                ...
                s && (e += '_mouseWheelClick'),
                  Object(c.trackEvent)(n.category, n.event, e);
              }
            },
            onMouseOver: j,
            onMouseOut: I,
          ...
          void 0 !== k &&
            a.a.createElement(
              'div',
              { onClick: p, className: r(T.toolbox, { [T.showOnHover]: S }) },
              k,
            ),
        );
        var P;
        ...
        render() {
          ...
          return s.createElement(
            ...
            s.createElement(
              ...
              s.createElement(
                'div',
                { className: u.tabsWrap },
                s.createElement(h, { className: u.tabs }, e),
              ),
            ),
          );
        }
        _generateDialogTabs() {
          ...
          return t.allIds.map((n) => {
            ...
            return s.createElement(
              ...
              {
                key: n,
                className: o(u.tab, !r && u.withHover),
                isActive: r,
    ...
    'uUY/': function (e, t, n) {
      ...
      function O(e) {
        const { initialGoToDate: t, children: n } = e,
          ...
          c = Object(s.useMemo)(() => ({ date: a, setDate: r, isValid: i }), [
            a,
            i,
          ]);
        ...
        constructor() {
          super(...arguments),
            (this._renderWeekdays = () =>
              B.map((e) => s.createElement('span', { key: e }, e)));
        }
        render() {
          return s.createElement(
            'div',
        ...
        render() {
          return s.createElement(
            'div',
            {
              className: N(
                z.calendar,
                this.props.popupStyle && z.popupStyle,
            ...
            s.createElement(
              ...
              s.createElement(W.a, {
                ...
                className: N(z.switchBtn, z.prev),
              }),
              s.createElement(
                'div',
                { className: z.title },
                `${
                  K[this.state.viewDate.getMonth()]
                } ${this.state.viewDate.getFullYear()}`,
              ),
              s.createElement(W.a, {
                icon: V,
                onClick: this._nextMonth,
                className: N(z.switchBtn, z.next),
              }),
            ),
            s.createElement(q, {
        ...
        return o.a.createElement(
          ...
          t &&
            o.a.createElement(oe, {
              text: Object(S.t)('Please enter the right date'),
      ...
      function me(e) {
        return o.a.createElement(
          U,
          Object.assign({}, e, { className: pe.calendar, popupStyle: !1 }),
        );
      }
      function fe(e, t) {
        const n = new Date(t);
      ...
      function ge(e) {
        const {
          ...
          { dateFrom: r, dateTo: c, setDateFrom: l, setDateTo: u } = Object(
            i.ensureNotNull,
          )(Object(s.useContext)(E)),
          [h, d] = Object(s.useState)('from'),
          p = Object(s.useRef)(null),
          m = Object(s.useRef)(null),
          f = Object(s.useRef)(null),
          v = Object(s.useMemo)(
            () => ('from' === h ? new Date(r) : new Date(c)),
            [h, c, r],
          );
        return (
          Object(s.useEffect)(() => {
      ...
      const _e = Modernizr.mobiletouch,
        ...
        Ee = {
          byId: {
            Date: { title: 'Date' },
            CustomRange: { title: 'Custom range' },
          },
      ...
      function ye(e) {
        const { dateOnly: t, onClose: n, onGoToDate: a, onGoToRange: r } = e,
          ...
          { dateFrom: f, dateTo: v, isValid: b } = Object(i.ensureNotNull)(
            Object(s.useContext)(E),
          );
        return (
          Object(s.useEffect)(
      ...
      function Re(e) {
        ...
        return t
          ? { from: b(t.from), to: b(t.to) }
          : { from: b(new Date()), to: b(new Date()) };
      }
    },
    v1bN: function (e, t, n) {
      e.exports = {
