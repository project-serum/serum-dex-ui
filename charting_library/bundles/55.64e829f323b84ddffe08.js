      ...
      function r(e) {
        return s.createElement(
          ...
          s.createElement(
            ...
            s.createElement('div', { className: a.line }),
            e.hint
              ? s.createElement('div', { className: a.hint }, e.hint)
              : null,
          ),
        );
      }
        ...
        render() {
          ...
          return s.createElement(
            ...
            s.createElement(
              ...
              s.createElement(
                'td',
                { className: l(i.iconCell), 'data-icon-cell': !0 },
                this._icon(),
              ),
              s.createElement(
                'td',
                ...
                s.createElement(
                  ...
                  s.createElement(
                    'span',
                    {
                      className: l(i.label, this.props.checked && i.checked),
                      'data-label': !0,
                    },
                    this.props.label,
                  ),
          ...
          return this.props.toolbox
            ? s.createElement(
                'span',
                {
                  className: l(
                    i.toolbox,
                    this.props.showToolboxOnHover && i.showToolboxOnHover,
                  ),
          ...
          super(e),
            ...
            (this._handleClick = (e) => {
              e.isDefaultPrevented() ||
                ...
                (this._hasSubItems()
                  ? this._showSubMenu()
                  : (this.state.doNotCloseOnClick || Object(b.b)(),
    ...
    l4ku: function (e, t, n) {
      ...
      function p(e) {
        ...
        return n
          ? o.a.createElement(
              'li',
              { className: a(d.item, d.loading) },
              o.a.createElement(i.a, { color: 'gray' }),
            )
          : o.a.createElement(
              'li',
              {
              ...
              o.a.createElement(
                'span',
                { className: a(d.label, y && d.fullWidth) },
                w,
              ),
              !!O &&
                o.a.createElement(r.a, {
              ...
              !N &&
                C &&
                o.a.createElement(c.a, { className: d.shortcut, text: C }),
