  ...
  ['new-edit-object-dialog'],
  {
    ...
    CHgb: function (e, t, n) {
      ...
      function d(e) {
        const { menuItemClassName: t } = e,
          n = Object(l.a)(e, ['menuItemClassName']);
        return r.a.createElement(
          i.a,
          Object.assign({}, n, { menuItemClassName: o()(t, p.itemWrap) }),
        );
      }
      function u(e) {
        return r.a.createElement(
          'div',
          { className: o()(p.item, p.selected) },
          r.a.createElement(c.a, { className: p.icon, icon: e.icon }),
        );
      }
      function h(e) {
        return r.a.createElement(
          ...
          r.a.createElement(c.a, {
            className: o()(p.icon, e.iconClassName),
            icon: e.icon,
          }),
          r.a.createElement('div', { className: p.label }, e.label),
        );
      }
    },
    D2im: function (e, t) {
    ...
    'K+KL': function (e, t, n) {
      ...
      var l = n('mrSG'),
        ...
        d = n('zS+2'),
        u = n('UmON');
      const h = { role: 'listbox' },
        m = r.a.forwardRef((e, t) => {
          const {
              id: n,
              tabIndex: a = 0,
              listboxTabIndex: m = -1,
            ...
            M = void 0 !== n ? Object(o.a)(n, 'listbox') : void 0,
            D = Object(p.c)(N),
            R = Object(p.a)(_, k);
          return r.a.createElement(
            c.a,
            Object.assign({}, S, T, {
              ...
              onKeyDown: function (e) {
                const t = Object(i.hashFromEvent)(e);
                if (D(t) || R(t)) return void e.preventDefault();
              },
              listboxAria: E,
              listboxId: M,
              listboxTabIndex: _ ? 0 : m,
              listboxReference: B,
              onListboxKeyDown: function (e) {
                _ &&
                  27 === Object(i.hashFromEvent)(e) &&
                  (e.stopPropagation(), k());
              },
            }),
            w,
      ...
      function c(e) {
        return class extends l.PureComponent {
          ...
          render() {
            ...
            return l.createElement(
              'div',
              { className: a(t, s.tabs), 'data-name': this.props['data-name'] },
              n,
              l.createElement(e, {
                reference: (e) => {
                  this._slider = e;
          ...
          _generateTabs() {
            return (
              ...
              l.Children.map(this.props.children, (e) => {
                ...
                return l.cloneElement(t, a);
              })
            );
          }
          _componentDidUpdate() {
            const e = Object(r.ensureNotNull)(this._slider).style;
    ...
    KacW: function (e, t, n) {
      ...
      var l = n('q1tI'),
        ...
        u = n('J4oI');
      const h = [
        { type: o.LINESTYLE_SOLID, icon: c, label: window.t('Line') },
        { type: o.LINESTYLE_DASHED, icon: p, label: window.t('Dashed Line') },
        { type: o.LINESTYLE_DOTTED, icon: d, label: window.t('Dotted Line') },
      ];
        ...
        render() {
          ...
          let p = (function (e) {
            ...
            return (
              ...
              t.map((e) => ({
                value: e.type,
                selectedContent: a.a.createElement(i.a, { icon: e.icon }),
                content: a.a.createElement(i.b, {
                  icon: e.icon,
                  label: e.label,
                }),
              }))
          ...
          return (
            o && (p = [{ id: 'additional', readonly: !0, content: o }, ...p]),
            a.a.createElement(i.c, {
              id: e,
              disabled: r,
              className: s()(u.lineStyleSelect, n),
              hideArrowButton: !0,
              items: p,
              value: t,
              onChange: l,
    ...
    MB0Y: function (e, t, n) {
      ...
      class p extends l.PureComponent {
        render() {
          const e = this.props,
            ...
            s = Object(o.a)(e, ['reference', 'size', 'intent']),
            p = r(i.input, -1 !== this.props.tabIndex && i.focus);
          return l.createElement(
            'div',
            { className: c(this.props) },
            l.createElement(
              'input',
              Object.assign({}, s, { type: 'checkbox', className: p, ref: t }),
            ),
            l.createElement(
              'div',
      ...
      function m(e) {
        const {
          ...
          g = s()(b.label, n && !c && b.labelOn),
          w = s()(t, b.wrapper, n && b.wrapperWithOnLabel);
        return a.a.createElement(
          'label',
          { className: w, htmlFor: l, ref: h },
          a.a.createElement(
            'div',
            { className: b.labelRow },
            a.a.createElement('div', { className: g }, r),
            o && a.a.createElement('div', { className: b.labelHint }, o),
          ),
          a.a.createElement(
            p,
            Object.assign(
          ...
          Object.assign(
            {
              id: t,
              disabled: p,
              className: s()(r, c.defaultSelect),
              menuClassName: c.defaultSelect,
              items:
                ((u = l), u.map((e) => ({ value: e.value, content: e.title }))),
              value: n,
              onChange: d,
            },
            Object(i.b)(e),
    ...
    Y5hB: function (e, t, n) {
      ...
      class _ extends r.PureComponent {
        render() {
          const {
            ...
            o = Object.assign(Object.assign({}, e), { optionsTitles: s });
      ...
      const T = r.createContext(null),
        I = window.t('{currency} per order'),
        L = window.t('{currency} per contract');
      class B extends r.PureComponent {
        render() {
          const { input: e } = this.props,
            t = Object(o.ensureNotNull)(this.context),
            n = {
              percent: '%',
              cash_per_order: I.format({ currency: t }),
              cash_per_contract: L.format({ currency: t }),
            },
            l = Object.assign(Object.assign({}, e), { optionsTitles: n });
          return r.createElement(S.a, { input: l });
        }
      }
      B.contextType = T;
      const M = window.t('Contracts'),
        D = window.t('% of equity');
      class R extends r.PureComponent {
        render() {
          const { input: e } = this.props,
            t = Object(o.ensureNotNull)(this.context),
            n = { fixed: M, cash_per_order: t, percent_of_equity: D },
            l = Object.assign(Object.assign({}, e), { optionsTitles: n });
          return r.createElement(S.a, { input: l });
        }
      }
        ...
        render() {
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(f.a, { input: e.initial_capital }),
            ),
            r.createElement(
              O.a,
              { label: window.t('Base currency') },
              r.createElement(P, { input: e.currency }),
            ),
            r.createElement(
              O.a,
              ...
              r.createElement(
                j.a,
                null,
                r.createElement(f.a, { input: e.default_qty_value }),
                r.createElement(R, { input: e.default_qty_type }),
              ),
            ),
            r.createElement(
              O.a,
              ...
              r.createElement(
                'span',
                null,
                r.createElement(f.a, { input: e.pyramiding }),
              ),
              r.createElement(
                'span',
                { className: z.descriptionCell },
                window.t('orders', { context: 'Pyramiding: count orders' }),
              ),
            ),
            r.createElement(N.a.Separator, null),
            r.createElement(
              O.a,
              ...
              r.createElement(
                j.a,
                null,
                r.createElement(f.a, { input: e.commission_value }),
            ...
            r.createElement(
              ...
              r.createElement(
                'span',
                null,
                r.createElement(f.a, { input: e.slippage }),
              ),
              r.createElement(
                'span',
                { className: z.descriptionCell },
            ...
            r.createElement(N.a.Separator, null),
            Object(V.isFeatureEnabled)('show_strategy_margin_inputs') &&
              e.margin_long &&
              e.margin_short &&
              r.createElement(
                r.Fragment,
                ...
                r.createElement(
                  ...
                  r.createElement(
                    'span',
                    null,
                    r.createElement(f.a, { input: e.margin_long }),
                  ),
                  r.createElement(
                    'span',
                    { className: z.descriptionCell },
                ...
                r.createElement(
                  ...
                  r.createElement(
                    'span',
                    null,
                    r.createElement(f.a, { input: e.margin_short }),
                  ),
                  r.createElement(
                    'span',
                    { className: z.descriptionCell },
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(
                  'div',
                  { className: z.recalculateCheckbox },
                  r.createElement(x.a, {
      ...
      function H(e) {
        ...
        return r.createElement(
          ...
          r.createElement(F, { inputs: l }),
        );
      }
      F.contextType = k.b;
      var A = n('z61+'),
        W = n('txPx');
      const G = Object(W.getLogger)(
      ...
      class U extends r.PureComponent {
        constructor(e) {
          ...
          if (((this._source = t), !Object(w.isStudy)(this._source)))
      ...
      var Y = n('RMU6'),
        ...
        Z = n('Z1Tk'),
        $ = n('S0KV');
      const ee = window.t('Change Visibility');
        ...
        constructor() {
          super(...arguments),
            (this._onChange = (e) => {
              ...
              n && Object($.b)(n, (n) => t(n, e, ee));
            });
        }
        render() {
          const { id: e, title: t, visible: n, disabled: l } = this.props,
            a = Object(i.clean)(window.t(t, { context: 'input' }), !0);
      ...
      const me = {
        ...
        be = Object.values(me)
          ...
          .map((e) => ({
            value: e.type,
            selectedContent: s.a.createElement(ae.a, { icon: e.icon }),
            content: s.a.createElement(ae.b, { icon: e.icon, label: e.label }),
          })),
      ...
      var we = n('lkVX'),
        ye = n('wwEg');
      const Ce = window.t('Change Plot Type'),
        fe = window.t('Change Price Line');
          ...
          return r.createElement(
            O.a,
            {
              ...
              label: r.createElement(
                'div',
                { className: ye.childRowContainer },
            ...
            r.createElement(we.a, {
              ...
              thickness: a ? i.width : void 0,
              isPaletteColor: !0,
            }),
            a && s && l.plottype && l.trackPrice
              ? r.createElement(ge, {
                  id: Object(Y.a)(e, 'plot-type-select'),
                  disabled: !l.visible.value(),
                  className: ye.smallStyleControl,
      ...
      class Se extends r.PureComponent {
        render() {
          const {
            ...
            i = e ? e.id : Object(o.ensureDefined)(t).id,
            c = !i.startsWith('fill') && e && Object(Q.isLinePlot)(e);
          return r.createElement(
            r.Fragment,
            null,
            !a &&
            ...
            (function (e, t, n, l, a) {
              ...
              return Object.keys(s).map((t, n) =>
                r.createElement(Ee, {
                  ...
                  id: e,
                  grouped: !0,
                  paletteColor: Object(o.ensureDefined)(s[t]),
                  paletteColorProps: Object(o.ensureDefined)(i[t]),
                  styleProp: l,
                  isLine: a,
            ...
            r.createElement(N.a.GroupSeparator, null),
          );
        }
      }
      Se.contextType = Z.b;
      const _e = window.t('Change Plot Type'),
        Pe = window.t('Change Price Line');
      ...
      class je extends r.PureComponent {
        render() {
          ...
          return r.createElement(Oe.Consumer, null, (n) =>
            r.createElement(
              O.a,
              {
                label: r.createElement(te, {
                  id: e,
                  title: ke(Object(o.ensureNotNull)(n), e),
                  visible: t,
                }),
              },
              this._upColorControl(),
              this._downColorControl(),
            ),
          );
        }
        _upColorControl() {
          const {
            isRGB: e,
            property: { colorup: t, transparency: n, visible: l },
          } = this.props;
          return e
            ? null
            : r.createElement(we.a, {
        ...
        _downColorControl() {
          const {
            isRGB: e,
            property: { colordown: t, transparency: n, visible: l },
          } = this.props;
          return e
            ? null
            : r.createElement(
                'span',
                { className: ye.additionalSelect },
                r.createElement(we.a, {
                  disabled: !l.value(),
                  color: t,
                  transparency: n,
      ...
      function ke(e, t) {
        const n = Object(o.ensureDefined)(e.metaInfo().styles),
          { title: l } = Object(o.ensureDefined)(n[t]);
        return Object(o.ensureDefined)(l);
      }
      je.contextType = Z.b;
      var Ne = n('/SnT'),
        Te = n.n(Ne),
        ...
        De = n('972a');
      const Re = {
          [De.MarkLocation.AboveBar]: {
            value: De.MarkLocation.AboveBar,
            content: window.t('Above Bar'),
            order: 0,
          },
          [De.MarkLocation.BelowBar]: {
            value: De.MarkLocation.BelowBar,
          ...
          [De.MarkLocation.Bottom]: {
            value: De.MarkLocation.Bottom,
            content: window.t('Bottom'),
            order: 3,
          },
          [De.MarkLocation.Absolute]: {
            value: De.MarkLocation.Absolute,
            content: window.t('Absolute'),
            order: 4,
          },
        },
        Ve = Object.values(Re).sort((e, t) => e.order - t.order);
      ...
      const Fe = window.t('Change Char'),
        He = window.t('Change Location');
      class Ae extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(
            ...
            r.createElement(ze, {
              id: Object(Y.a)(e, 'shape-style-select'),
              disabled: !i.value(),
              className: Ie(ye.defaultSelect, ye.additionalSelect),
              menuItemClassName: ye.defaultSelectItem,
      ...
      const Ke = [];
      Object.keys(We.a).forEach((e) => {
        const t = We.a[e];
        Ke.push({
          id: t.id,
          value: t.id,
          selectedContent: s.a.createElement(ae.a, { icon: Ue(t.icon) }),
          content: s.a.createElement(ae.b, {
            icon: Ue(t.icon),
            label: t.guiName,
          }),
        });
      });
      class qe extends s.a.PureComponent {
        render() {
          const {
            id: e,
            shapeStyleId: t,
      ...
      const Ye = window.t('Change Shape'),
      ...
      class Je extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(
            ...
            r.createElement(ze, {
              id: Object(Y.a)(e, 'shape-location-select'),
              disabled: !c.value(),
              className: Ie(ye.defaultSelect, ye.additionalSelect),
              menuItemClassName: ye.defaultSelectItem,
      ...
      class Xe extends r.PureComponent {
        render() {
          ...
          return r.createElement(
            ...
            {
              label: c
                ? r.createElement(te, { id: e, title: n, visible: l })
                : n,
            },
            t
              ? null
      ...
      Xe.contextType = Z.b;
      var Ze = n('m/cY');
      const $e = Object(W.getLogger)('Chart.Study.PropertyPage'),
        et = Object(l.t)('Wick'),
        tt = Object(l.t)('Border'),
        nt = Object(l.t)('Arrow Up Color'),
        lt = Object(l.t)('Arrow Down Color');
      class at extends r.PureComponent {
        render() {
          ...
          if ('line' === s || 'bar_colorer' === s || 'bg_colorer' === s) {
            const n = t.main;
            return n && n.palette && n.paletteProps
              ? r.createElement(Se, {
                  plot: e,
                  palette: n.palette,
                  paletteProps: n.paletteProps,
                  styleProp: a,
                })
              : r.createElement(xe, { id: l, property: a, isRGB: i });
          }
          if ('arrows' === s) {
            const n = t.up,
              s = t.down;
            return n || s
              ? r.createElement(
                  r.Fragment,
                  null,
                  n && n.palette && n.paletteProps
                    ? r.createElement(Se, {
                        plot: e,
                        palette: n.palette,
                        paletteProps: n.paletteProps,
                        styleProp: Object.assign(Object.assign({}, a), {
                          title: Object(Ze.a)(nt),
                        }),
                      })
                    : r.createElement(Xe, {
                        id: l,
            ...
            return r.createElement(
              ...
              'chars' === s
                ? r.createElement(Ae, {
                    id: l,
                    property: a,
                    hasPalette: Boolean(n && n.palette),
                    isRGB: i,
                  })
                : r.createElement(Je, {
                    id: l,
          ...
          if (Object(Q.isOhlcPlot)(e)) {
            const l = e.target,
              a = Object(o.ensureDefined)(n.metaInfo().defaults.ohlcPlots)[l],
              s = n.properties().ohlcPlots[l],
              c = t.main;
            let p, d;
            return (
              (p =
              ...
              void 0 !== a &&
                Object(Q.isOhlcPlotStyleCandles)(a) &&
                (d = r.createElement(
                  r.Fragment,
                  null,
                  t.wick && t.wick.palette && t.wick.paletteProps
                    ? r.createElement(Se, {
                        plot: e,
                        palette: t.wick.palette,
                        paletteProps: t.wick.paletteProps,
                        styleProp: Object.assign(Object.assign({}, s), {
                          title: Object(Ze.a)(et),
                        }),
                      })
                    : r.createElement(Xe, {
                        id: l,
                  ...
                  t.border && t.border.palette && t.border.paletteProps
                    ? r.createElement(Se, {
                        plot: e,
                        palette: t.border.palette,
                        paletteProps: t.border.paletteProps,
                        styleProp: Object.assign(Object.assign({}, s), {
                          title: Object(Ze.a)(tt),
                        }),
                      })
                    : r.createElement(Xe, {
                        id: l,
                        isRGB: i,
                        title: tt,
                        visible: s.drawBorder,
                        color: s.borderColor,
                        transparency: s.transparency,
                      }),
                )),
              r.createElement(r.Fragment, null, p, d)
            );
          }
          return $e.logError('Unknown plot type: ' + s), null;
        }
      }
      var rt = n('YS4w'),
        st = n('mrSG'),
        ot = n('KacW');
      const it = window.t('Change Line Style');
      class ct extends s.a.PureComponent {
        constructor() {
          super(...arguments),
            (this._onLineStyleChange = (e) => {
              const { setValue: t } = this.context,
                { lineStyle: n } = this.props;
              Object($.b)(n, (n) => t(n, e, it));
            });
        }
        render() {
          const e = this.props,
            { lineStyle: t } = e,
            n = Object(st.a)(e, ['lineStyle']);
          return s.a.createElement(
            ot.a,
            Object.assign({}, n, {
              lineStyle: Object($.a)(t),
      ...
      ct.contextType = Z.b;
      const pt = window.t('Change Value');
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(ct, {
                  id: Object(Y.a)(e, 'line-style-select'),
                  disabled: !i.value(),
                  className: ye.smallStyleControl,
                  lineStyle: l,
                }),
      ...
      var ht = n('KG+6'),
        mt = n('kk0y');
      const bt = [
          { value: ht.a.LeftToRight, content: window.t('Left') },
          {
            value: ht.a.RightToLeft,
            content: window.t('Right'),
          },
        ],
        vt = window.t('Width (% of the Box)'),
        gt = window.t('Placement'),
        wt = window.t('Show Values'),
        yt = window.t('Text Color'),
        Ct = window.t('Change Percent Width'),
        ft = window.t('Change Placement'),
        Et = window.t('Change Show Values');
        ...
        render() {
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(we.a, { disabled: s && !s.value(), color: a }),
            ),
            this._renderColors(),
            r.createElement(N.a.GroupSeparator, null),
          );
      ...
      class _t extends r.PureComponent {
        render() {
          ...
          return r.createElement(
            ...
            r.createElement(ct, {
              id: Object(Y.a)(e.value(), 'line-style-select'),
              disabled: !s.value(),
              className: ye.smallStyleControl,
              lineStyle: a,
            }),
        ...
        render() {
          ...
          return Object.keys(a).map((t, n) => {
            ...
            return 'horizlines' === e || 'vertlines' === e || 'lines' === e
              ...
              : 'hhists' === e
              ? r.createElement(St, { key: t, property: a })
              : null;
          });
        }
      }
      const xt = window.t('Change Font'),
        Ot = [
          'Verdana',
          'Courier New',
          'Times New Roman',
          'Arial',
        ].map((e) => ({ value: e, content: e }));
      class jt extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(Me.a, {
            id: e,
            disabled: l,
            className: Le()(n, ye.defaultSelect),
            menuItemClassName: ye.defaultSelectItem,
            items: Ot,
            value: t.value(),
      ...
      jt.contextType = Z.b;
      var kt = n('UXjO');
      const Nt = window.t('Change Font Size'),
        Tt = [10, 11, 12, 14, 16, 20, 24, 28, 32, 40].map((e) => ({
          value: e,
          title: e.toString(),
        }));
      ...
      It.contextType = Z.b;
      const Lt = window.t('Change Visibility'),
        Bt = window.t('Labels Font'),
        Mt = window.t('Show Labels'),
        Dt = {
          Traditional: new Set([
            'S5/R5',
            'S4/R4',
      ...
      class Rt extends s.a.PureComponent {
        constructor() {
          super(...arguments),
            (this._onChange = (e) => {
              const { setValue: t } = this.context,
        ...
        render() {
          ...
          return s.a.createElement(
            ...
            s.a.createElement(
              ...
              {
                labelAlign: 'adaptive',
                label: s.a.createElement('span', null, Bt),
              },
              s.a.createElement(
                'div',
                { className: ye.block },
                ...
                s.a.createElement(
                  'div',
                  { className: Ie(ye.wrapGroup, ye.additionalSelect) },
        ...
        _renderColors() {
          const { levelsStyle: e, inputs: t } = this.props.property.childs(),
            ...
            { kind: r } = t.childs(),
            i = Object(o.ensureDefined)(Dt[r.value()]);
          return n
            .childNames()
            .filter((e) => i.has(e))
            .map((e) =>
      ...
      Rt.contextType = Z.b;
      const Vt = Object(l.t)('Change Visibility'),
        zt = Object(l.t)('Volume Profile'),
        Ft = Object(l.t)('Show Values'),
        Ht = Object(l.t)('Width (% of the Box)'),
        At = Object(l.t)('Placement'),
        Wt = Object(l.t)('Developing VA'),
        Gt = [
          { value: ht.a.RightToLeft, content: Object(l.t)('Right') },
          { value: ht.a.LeftToRight, content: Object(l.t)('Left') },
        ];
      class Ut extends s.a.PureComponent {
        constructor() {
          super(...arguments),
            (this._onChange = (e) => {
        ...
        render() {
          ...
          const { metaInfo: n } = this.props,
            ...
            { hhists: i, horizlines: c, polygons: p } = a.childs(),
            d = Object(o.ensureDefined)(n.graphics.hhists),
            u = Object.keys(d),
            h = i.childs()[u[0]],
            m = h.childs().visible,
            b = u.map((e) => i.childs()[e].childs().showValues),
            v = h.childs().percentWidth,
            g = h.childs().direction,
            w = u.map((e) => i.childs()[e].childs().valuesColor),
            y = c.childs().pocLines,
            C = Object(o.ensureDefined)(
              null === (e = n.graphics.horizlines) || void 0 === e
                ? void 0
                : e.pocLines,
            ),
            f = r.childs().developingPoc,
            E = Object(o.ensureDefined)(
              null === (t = n.styles) || void 0 === t
                ? void 0
                : t.developingPoc,
            ),
            S = r.childs().developingVAHigh,
            _ = r.childs().developingVALow,
            P = n.graphics.polygons && n.graphics.polygons.histBoxBg;
          return s.a.createElement(
            s.a.Fragment,
            null,
            s.a.createElement(
                ...
                i
                  ...
                  .map((t, n) => {
                    ...
                    return s.a.createElement(
                      ...
                      s.a.createElement(we.a, {
                        disabled: !m.value(),
                        color: i.childs()[e].childs().colors.childs()[n],
                        transparency: i
                          .childs()
                          [e].childs()
            ...
            S &&
              ...
              s.a.createElement(
                Xe,
                {
                  id: 'developingPoc',
                  title: Wt,
                  color: [S.childs().color, _.childs().color],
                  visible: [S.childs().visible, _.childs().visible],
                  thickness: [S.childs().linewidth, _.childs().linewidth],
                },
                s.a.createElement(ct, {
                  id: 'developing-VA-line-style-select',
                  disabled:
                    !S.childs().visible.value() && !_.childs().visible.value(),
                  className: ye.smallStyleControl,
                  lineStyle: [S.childs().linestyle, _.childs().linestyle],
                }),
              ),
            p &&
              s.a.createElement(
        ...
        _setHhistsProperty(e, t) {
          const { setValue: n } = this.context,
            ...
            s = Object.keys(Object(o.ensureDefined)(l.graphics.hhists));
          for (let i = 0; i < s.length; i++) {
            const l = r.childs()[s[i]].child(e);
            n(Object(o.ensureDefined)(l), t, Vt);
          }
        }
      }
      Ut.contextType = Z.b;
      ...
      const qt = {
        PivotPointsStandard: function () {
          const e = Object(o.ensureNotNull)(
            Object(r.useContext)(Oe),
          ).properties();
          return s.a.createElement(Rt, { property: e });
        },
        VbPVisible: function () {
          const e = Object(o.ensureNotNull)(Object(r.useContext)(Oe)),
            t = e.metaInfo(),
            n = e.properties();
          return s.a.createElement(Ut, { metaInfo: t, property: n });
        },
      };
      class Yt extends r.PureComponent {
        render() {
          const e = Object(o.ensureNotNull)(this.context);
          return r.createElement(Oe.Consumer, null, (t) =>
            r.createElement(
              Z.a,
              { property: Object(o.ensureNotNull)(t).properties(), model: e },
              r.createElement(
                N.a,
                null,
                this._renderCustomContent(
                  Object(o.ensureNotNull)(t).metaInfo().shortId,
                ),
              ),
            ),
          );
      ...
      Yt.contextType = Kt.a;
      var Qt = n('Ecpn');
      const Jt = window.t('Default'),
        Xt = window.t('Precision'),
        Zt = window.t('Change Precision'),
        $t = [{ value: 'default', content: Jt }];
      for (let bn = 0; bn <= 8; bn++)
        $t.push({ value: bn, content: bn.toString() });
      ...
      const tn = window.t('Default'),
        nn = window.t('Override Min Tick'),
        ln = window.t('Change Min Tick'),
        an = [
        ...
        rn = [{ id: 'tick-default', value: 'default', content: tn }];
      for (let bn = 0; bn < an.length; bn++) {
        const e = an[bn];
        rn.push({
          value: e.priceScale + ',' + e.minMove + ',' + e.frac,
          content: e.minMove + '/' + e.priceScale,
        });
      }
      ...
      sn.contextType = Z.b;
      var on = n('5YG5');
      class cn extends r.PureComponent {
        constructor() {
          super(...arguments),
            (this._findPlotPalettes = (e) => {
              const { study: t } = this.props,
                n = t.metaInfo(),
                l = Object(o.ensureDefined)(n.palettes);
        ...
        render() {
          const { study: e } = this.props,
            t = e.metaInfo();
          if (Object(Qt.a)(t.shortId)) return r.createElement(Yt, null);
          const n = e.properties(),
            { precision: l, strategy: a, minTick: s } = n,
            o = t.plots.length > 0,
            i = Object(on.a)(e).canOverrideMinTick();
          return r.createElement(
            N.a,
            null,
            this._plotsElement(),
            ...
            o &&
              r.createElement(en, {
                id: Object(Y.a)(t.id, 'precision-select'),
                precision: l,
              }),
            i &&
              r.createElement(sn, {
                id: Object(Y.a)(t.id, 'min-tick-select'),
                minTick: s,
              }),
            X.a.isScriptStrategy(t) &&
              r.createElement(ut, { orders: a.orders }),
          );
        }
        _plotsElement() {
          const { study: e } = this.props,
          ...
          return new A.a(t)
            ...
            .filter(
              (e) =>
                !(
                  Object(Q.isUpColorerPlot)(e) ||
                  Object(Q.isDownColorerPlot)(e) ||
                  Object(Q.isCandleBorderColorerPlot)(e) ||
                  Object(Q.isCandleWickColorerPlot)(e)
                ),
            )
            .map((t) => {
              const n = Object(Q.isOhlcPlot)(t)
                  ? Object.assign(Object.assign({}, t), { id: t.target })
                  : t,
            ...
            : n.map((t) => {
                ...
                if (t.palette) {
                  const e = this._findPalettesByTargetId(t.id),
                    l = Object(o.ensureDefined)(e.main);
                  return r.createElement(Se, {
                    key: t.id,
                    area: t,
                    palette: Object(o.ensureDefined)(l.palette),
                    paletteProps: Object(o.ensureDefined)(l.paletteProps),
                    styleProp: n,
                  });
                }
        ...
        _graphicsElement() {
          ...
          return (
            ...
            Object.keys(t).map((t, n) =>
              r.createElement(Pt, { key: t, graphicType: t, study: e }),
            )
          );
        }
        _findPalettesByTargetId(e) {
          const { study: t } = this.props,
            n = t.metaInfo(),
            l = n.plots,
            a = Object(o.ensureDefined)(n.palettes),
            r = {};
          for (const s of l)
            (Object(Q.isColorerPlot)(s) || Object(Q.isOhlcColorerPlot)(s)) &&
              s.target === e &&
              (r.main = {
                palette: a[s.palette],
                paletteProps: t.properties().palettes[s.palette],
              }),
              Object(Q.isUpColorerPlot)(s) &&
                s.target === e &&
                (r.up = {
                  palette: a[s.palette],
                  paletteProps: t.properties().palettes[s.palette],
                }),
              Object(Q.isDownColorerPlot)(s) &&
                s.target === e &&
                (r.down = {
                  palette: a[s.palette],
                  paletteProps: t.properties().palettes[s.palette],
                }),
              Object(Q.isCandleWickColorerPlot)(s) &&
                s.target === e &&
                (r.wick = {
                  palette: a[s.palette],
                  paletteProps: t.properties().palettes[s.palette],
                }),
              Object(Q.isCandleBorderColorerPlot)(s) &&
                s.target === e &&
                (r.border = {
                  palette: a[s.palette],
                  paletteProps: t.properties().palettes[s.palette],
        ...
        render() {
          return r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(pn, { study: this.props.source }),
            ),
          );
        }
      }
      ...
      class mn extends hn.a {
        ...
        show(e = {}) {
          ...
          if (
            ...
            Object(w.isStudy)(this._source))
          ) {
            const e =
              !this._source.isPine() || this._source.isStandardPine()
                ? t.description
                : 'Custom Pine';
            Object(u.trackEvent)('GUI', 'Study Properties', e);
          }
          let n = {
            byId: {
              inputs: { title: window.t('Inputs'), Component: q },
              style: { title: window.t('Style'), Component: dn },
          ...
          const s =
            ...
            'inputs';
          let o = Object(i.clean)(t.shortDescription, !0);
          a.render(
            r.createElement(C, {
              title: o,
              model: this._model,
        ...
        _getPagesForStudyLineTool(e) {
          if (this._propertyPages) {
            ...
            return {
              ...
              byId: Object.assign(Object.assign({}, e.byId), n.byId),
            };
          }
          return e;
        }
    ...
    aDg1: function (e, t, n) {
      ...
      var l = n('q1tI'),
        ...
        s = n('nPPD'),
        o = n('dMmr');
      const i = Object(s.a)(r.a, o);
      var c = n('4Cm8'),
        p = n('5VK0');
      n.d(t, 'a', function () {
        return u;
      });
      const d = Object(r.c)(function (e) {
        return l.createElement(
          'div',
          { className: i.slider, ref: e.reference },
          l.createElement('div', { className: i.inner }),
        );
      });
      class u extends l.PureComponent {
        ...
        render() {
          ...
          return l.createElement(
            'div',
            { className: p.scrollWrap },
            l.createElement('div', {
              className: p.headerBottomSeparator,
            }),
            l.createElement(
              c.a,
              {
              ...
              l.createElement(
                'div',
                { className: p.tabsWrap },
                l.createElement(d, { className: p.tabs }, e),
              ),
            ),
          );
        }
        _generateDialogTabs() {
          ...
          return t.allIds.map((n) => {
            ...
            return l.createElement(
              ...
              {
                key: n,
                className: a(p.tab, !s && p.withHover),
                isActive: s,
                onClick: this._createClickHandler(n),
              },
              t.byId[n].title,
            );
          });
    ...
    nPPD: function (e, t, n) {
      ...
      function l(e, t, n = {}) {
        ...
        for (const a of Object.keys(t)) {
          const r = n[a] || a;
          r in e && (l[a] = [e[r], t[a]].join(' '));
        }
        return l;
      }
      function a(e, t, n = {}) {
        return Object.assign({}, e, l(e, t, n));
      }
      n.d(t, 'b', function () {
        return l;
      }),
    ...
    vHME: function (e, t, n) {
      ...
      class u extends l.PureComponent {
        ...
        render() {
          ...
          return l.createElement(
            o.a,
            {
              ...
              className: r()('normal' === e && p.defaultsButtonText),
        ...
        _getPlaceHolderItem(e) {
          return e
            ? l.createElement(s.a, { className: p.defaultsButtonIcon, icon: c })
            : d.defaults;
        }
      }
    },
