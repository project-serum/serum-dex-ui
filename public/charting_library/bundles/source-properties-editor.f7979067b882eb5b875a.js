        ...
        return i.createElement(
          ...
          i.createElement(f.b, {
            ...
            toolbox:
              s &&
              i.createElement(g.a, {
                hidden: !Modernizr.mobiletouch && !n,
                onClick: l,
              }),
          }),
        );
            ...
            e.page &&
              i.createElement(
                ...
                e.page.definitions
                  .value()
                  .map((e) =>
                    i.createElement(q.a, { key: e.id, definition: e }),
                  ),
              ),
          ),
        );
      ...
      class O extends i.PureComponent {
        constructor(e) {
          ...
          if (this._getActionPageById(this.props.activePageId))
            s = Object(r.ensureDefined)(this.props.activePageId);
          else {
    ...
    K3s3: function (e, t, s) {
      ...
      function c(e) {
        return class extends i.PureComponent {
          ...
          componentDidUpdate() {
            (Object(n.ensureNotNull)(this._slider).style.transition =
              'transform 350ms'),
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              i.createElement(
                ...
                i.createElement(d, { className: u.tabs }, e),
              ),
            ),
          );
        }
        _generateDialogTabs() {
          ...
          return t.allIds.map((s) => {
            ...
            return i.createElement(
              ...
              {
                key: s,
                className: o(u.tab, !a && u.withHover),
                isActive: a,
    ...
    vHME: function (e, t, s) {
      ...
      class h extends i.PureComponent {
        ...
        _getPlaceHolderItem(e) {
          return e
            ? i.createElement(a.a, { className: u.defaultsButtonIcon, icon: c })
            : d.defaults;
        }
      }
    },
