        ...
        init() {
          if (
            ...
            this.$tab
              ...
              .append(this._overlayCheckbox.$el),
            d)
          ) {
            ...
            const t = $(
              '<div class="tv-add-symbol-tab__add-symbol-overlay"></div>',
            );
          ...
          Object(n.symbolSearchUIService)().bindToInput(this._$input, {
            callback: (t) => {
              ...
              if (e) {
                const s =
                  null !== this._extendTimeScaleCheckbox &&
                  this._extendTimeScaleCheckbox.checked;
            ...
            s &&
              ...
              s.dataSources().forEach((e) => {
                if (
                  ...
                  (i === t ||
                    (this._symbolAlias[i] && this._symbolAlias[i] === t)) &&
                    s.removeSource(e);
                }
              }));
          }
              ...
              this._predefines.forEach(({ symbol: t }) => {
                ...
                s.forEach((e) => {
                  if (
                    ...
                    (s === t ||
                      (this._symbolAlias[s] && this._symbolAlias[s] === t)) &&
          ...
          _initSymbolSearch() {
            (this._$input = this.$tab.find('.js-compare-tab-input')),
              Object(a.symbolSearchUIService)().bindToInput(this._$input, {
                ...
                onPopupOpen: (t) => {
                  t.css('z-index', this._dialog.getZIndex()),
                    (this._$popup = t);
                },
                onPopupClose: () => {
                  this._$popup = null;
            ...
            this._predefines.forEach(({ symbol: t, title: a }) => {
              const o = $(
                i.render(n, {
                  ...
                  label: a,
                  additionalClass: this._isBovespa
                    ? 'tv-compare-tab__predefine-cell--wide'
                    : '',
                }),
              );
              o.find('.js-predefine-checkbox').change({ symbol: t }, e),
                o.appendTo(s);
            }),
              s.appendTo(this.$tab);
          }
        ...
        function l(e) {
          ...
          e.contentAddClass && l.addClass(e.contentAddClass),
            !1 !== e.withScroll &&
              ...
              ).append(n.addClass('tv-dialog__scroll-wrap-inner')));
          const r = $('<div class="tv-tabbed-dialog">').append(s).append(l);
          if (
            (e.customControls &&
              s.find('.js-custom-controls').append(e.customControls),
      ...
      class v {
        ...
        checkScrollArrows(t = !1) {
          ...
          this._elArrowLeft &&
            (e >= 1
              ? n(this._elArrowLeft)
              : (e <= 1 || this._elScrollWrap.scrollWidth <= s) &&
                r(this._elArrowLeft, o.Left)),
            this._elArrowRight &&
              (i - e > 1
                ? n(this._elArrowRight)
                : (e >= i || this._elScrollWrap.scrollWidth <= s) &&
                  r(this._elArrowRight, o.Right));
        }
        index() {
        ...
        updateSlider(t, e, s) {
          ...
          if (d) {
            ...
            (n += parseInt(t.getPropertyValue('padding-left')) + d.offsetLeft),
              (r -= r - f(d));
          }
          (s = s || -1 === t || (document.all && !window.atob))
            ? ((this._elSlider.style.left = n + 'px'),
              (this._elSlider.style.width = r + 'px'))
            : ((this._animating = !0),
              a().then(() => {
                $.Velocity.animate(
                  this._elSlider,
        ...
        deselect() {
          ...
          this._options.activeTabClass &&
            t &&
            y(t, this._options.activeTabClass);
          const e = this.getElActivePage();
          return (
            this._options.activePageClass &&
              e &&
              y(e, this._options.activePageClass),
            this._elSlider &&
        ...
        _bindEvents() {
            ...
            this._elArrowRight &&
              this._bindOneEvent({
                ...
                listener: () => {
                  const t = this.getTabsArray();
                  let e = 0;
                  const s = Object(b.isRtl)()
                    ? 0
                    : this._elScrollWrap.scrollLeft + f(this._elScrollWrap);
                  Object(b.isRtl)() && t.reverse(),
                    t.forEach((t) => {
                      if (0 !== e) return;
                    ...
                    a().then(() => {
                      $.Velocity.animate(this._elScrollWrap, 'scroll', {
                        ...
                        offset: Math.ceil(
                          e -
                            s +
                            f(Object(i.ensureDefined)(this._elArrowRight)),
                        ),
                        queue: !1,
                      });
                    });
            ...
            t.forEach((t) =>
              this._bindOneEvent({
                ...
                listener: (t) => {
                  ...
                  e &&
                    this._options.activeTabClass &&
                    S(e, this._options.activeTabClass) &&
                    this._hoverSlider(e);
                },
                target: t,
              }),
          ...
          const s = () => {
            (e = null),
              this.checkScrollArrows(!0),
              this._options.noSlider || this.resizeSlider();
          };
          this._bindOneEvent({
            eventName: 'resize',
            listener: () => {
        ...
        _bindTabEvents(t) {
          this._bindOneEvent({
            eventName: 'click',
            listener: (t) => {
              'function' == typeof this._options.onTabClick
                ? this._options.onTabClick(t)
                : this.onTabClick(t);
            },
            target: t,
          });
        ...
        _unbindEvents(t) {
          ...
          this._bindings
            .filter(e)
            .forEach((t) =>
              t.target.removeEventListener(t.eventName, t.listener),
            ),
        ...
        _isTabDisabled(t) {
          return (
            ...
            (this._options.tabDisabledClass &&
              S(t, this._options.tabDisabledClass)) ||
        ...
        _hoverSlider(t) {
          ...
          a().then(() => {
            $.Velocity.animate(this._elSlider, { left: i }, o),
              $.Velocity.animate(this._elSlider, { width: e }, o);
          });
          const n = () => {
            this.getElActiveTab() === t && this._unhoverSlider(t),
              t.removeEventListener('mousleave', n);
          };
        ...
        _unhoverSlider(t) {
          ...
          a().then(() => {
            $.Velocity.animate(this._elSlider, { left: o }, d),
              $.Velocity.animate(this._elSlider, { width: r }, d);
          });
        }
      }
      function f(t) {
