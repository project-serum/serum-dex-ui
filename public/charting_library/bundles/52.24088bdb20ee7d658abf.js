  ...
  [52],
  {
          ...
          Object.assign(
            {
              ...
              className: n(z.button, r, d && l, {
                ...
                'common-tooltip-vertical': Boolean(w) && 'vertical' === u,
                [z.isActive]: d,
                [z.isGrayed]: L,
                [z.isHidden]: m,
                [z.isTransparent]: h,
    ...
    b2d7: function (o, e, l) {
      ...
      !(function (o) {
        function e() {
          o.favorites = [];
          Object(s.getJSON)('chart.favoriteDrawings', []).forEach((e) => {
        ...
        (o.favorites = []),
          ...
          (o.saveFavorites = function (e) {
            Object(s.setJSON)('chart.favoriteDrawings', o.favorites, e);
          }),
          e(),
        ...
        (function (o) {
          ...
          (o.favoriteAdded = new t.a()),
            ...
            (o.moveFavorite = function (n, a, t) {
              ...
              const s = i.favoriteIndex(n);
              return (
                -1 !== s &&
                a !== s &&
                (i.favorites.splice(s, 1),
                i.favorites.splice(a, 0, n),
                i.saveFavorites(t),
                o.favoriteMoved.fire(n, s, a),
                !0)
              );
            });
        })(n || (n = {}));
