  ...
  ['lt-pane-views'],
  {
        ...
        _updateImpl() {
          if (
            ...
            ((L = {}).points = [w, x]),
              ...
              (L.leftend = c.Normal),
              (L.rightend =
                Math.abs(w.x - x.x) >= 15 * L.linewidth ? c.Arrow : c.Normal),
            ...
            ((L = {}).text = C),
              ...
              t.drawBorder &&
                t.drawBorder.value() &&
                (L.borderColor = t.borderColor.value()),
      ...
      t.ParallelChannelPaneView = class extends r {
        ...
        _updateImpl() {
          if (
            ...
            var g = [];
            if (
              (this._points[0] && g.push(this._points[0]),
              this._points[1] && g.push(this._points[1]),
              this._p3)
            ) {
              var f = this._p3;
              (f.data = 2), g.push(f);
            ...
            this._model.lineBeingCreated() !== this._source ||
              ...
              (g.pop(), g.pop()),
              p.append(
                this.createLineAnchor({ points: g, pointsCursorType: o }),
              ),
              (this._renderer = p);
          }
        }
      ...
      class S extends m {
        ...
        drawTargetLabel(e) {
          ...
          if ((e.fillText(a, T + d + _ + 2 * u + D, M), this._data.status)) {
            var B, N, k, A;
            switch (
              ((e.font = x(this._targetFontSize1, this._font, 'bold')),
              this._data.status)
            ) {
      ...
      t.PredictionPaneView = class extends n {
        ...
        _updateImpl() {
          if (
              ...
              (this._targetLine4 = new c().format(l)),
                h ||
                  (this._targetLine4 =
                    this._targetLine4 +
                    '  ' +
                    new u(p ? '%h:%m:%s' : '%h:%m').format(l));
              var f = (l.valueOf() - a.valueOf()) / 1e3;
              this._targetLine2 =
                $.t('in', { context: 'dates' }) + ' ' + R(new _().format(f));
            }
            ...
            var x = new o();
            x.append(this._predictionRenderer),
              this.addAnchors(x),
              (this._renderer = x);
          }
        }
        ...
        _updateImpl() {
          if (
            ...
            if (
              ...
              r.append(this.createLineAnchor({ points: a })),
              t.wordWrapWidth)
            ) {
              var o = new n(
        ...
        _updateImpl() {
          ...
          if (1 === this._points.length) {
            ...
            (e.data = 0),
              (e.square = !0),
              i.append(
                this.createLineAnchor({ points: [e], pointsCursorType: h }),
              );
          }
          this._renderer = i;
        }
        ...
        _updateImpl() {
          ...
          for (
            ...
            if ((T = t['level' + d]).visible.value()) {
              ...
              b.setData(y),
                e.append(b),
                (t.showCoeffs.value() || t.showPrices.value()) && o(f, v, d);
            }
          }
          var R = null;
          for (d = h; d >= 1; d--) {
      ...
      class g {
        ...
        rowHeight(e) {
          const t = Object(r.ensureDefined)(this._rowsToSources.get(e)),
            i = Object(r.ensureDefined)(this._sourcesToRow.get(t))
              .effectiveState;
      ...
      t.ElliottLabelsPaneView = class extends n {
        ...
        _updateImpl() {
          ...
          if (t && !t.isEmpty() && !i.isEmpty()) {
            ...
            for (
              n = u(e.color.value()), f = 0;
              f < this._points.length - I;
              f++, M = -M
            )
              if (!(f < P)) {
      ...
      class u extends c.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          if (
            ...
            this._points.length >= 3 &&
              (this._trendLineRendererPoints12.setData(g(t, i)),
              _.append(this._trendLineRendererPoints12)),
            4 === this._points.length &&
              (this._trendLineRendererPoints23.setData(g(i, o)),
    ...
    KFbh: function (e, t, i) {
      ...
      const C = new (class {
        ...
        getItem(e, t) {
          const i = this._cachedItems.find(
            (i) =>
              i.sourceLabel === e &&
              Object(f.areEqualPaneRenderParams)(t, i.params),
          );
          ...
          for (let i = this._items.length - 1; i >= 0; --i) {
            ...
            if (s || a || o) {
              const e = {
                ...
                itemIndex: s || a ? n.itemIndex : n.labelIndex,
              };
              o
        ...
        draw(e, t) {
          ...
          for (const o of this._items) {
            ...
            e.moveTo(t, Math.round(T(o) * n)),
              ...
              0 !== o.poleTailHeight &&
                (e.moveTo(t, Math.round(P(o) * n)),
                e.lineTo(t, Math.round(L(o) * n)));
          }
          e.stroke();
          for (const o of this._items)
      ...
      function N(e, t) {
        ...
        switch (e.style()) {
          ...
          case 10:
            const e = Math.abs(
              100 - l.baselineStyle.baseLevelPercentage.value(),
            );
            a =
              (r.height() * e) / 100 > d
          ...
          case 12:
            ...
            break;
          case 0:
            a = l.barStyle.thinBars.value()
              ? 3
              : Math.max(3, 0.25 * h.barSpacing());
            break;
          case 11:
            a = l.rangeStyle.thinBars.value()
              ? 3
              : Math.max(3, 0.25 * h.barSpacing());
            break;
          case 4:
            ...
            const w = _.visualDirection !== _.positionPointDirection,
              ...
              b = {
                circleBackgroundColor:
                  c.backgroundPlateColor(s) || l.circleBackgroundColor,
      ...
      class j extends z.LineSourcePaneView {
        constructor(e, t) {
          super(e, t),
            (this._renderer = new A.CompositeRenderer()),
            (this._storiesEventsPaneView = new k(
              t,
              e,
        ...
        _updateImpl(e, t) {
          ...
          (a.data = s.data),
            ...
            this._renderer.append(
              this.createLineAnchor({
                points: [a],
                pointsCursorType: [E.PaneCursorType.VerticalResize],
              }),
            );
        }
      }
          ...
          return (
            this._textRendererData.points &&
              ...
              (this._textRenderer.setData(
                Object.assign({}, this._textRendererData),
              ),
        ...
        _updateImpl() {
          if (
            ...
            ((D = {}).points = [l, d]),
              ...
              (D.leftend = _.Normal),
              (D.rightend =
                Math.abs(i.x - n.x) >= 25 * D.linewidth ? _.Arrow : _.Normal),
            ...
            (l = new r(p, i.y + Math.sign(n.y - i.y) * s)),
              (d = new r(p, n.y + Math.sign(i.y - n.y) * s));
            ((D = {}).points = [l, d]),
              (D.width = this._model.timeScale().width()),
              (D.height = this._source.priceScale().height()),
              (D.color = this._source.properties().linecolor.value()),
              ...
              (D.leftend = _.Normal),
              (D.rightend =
                Math.abs(l.y - d.y) >= 25 * D.linewidth ? _.Arrow : _.Normal),
            ...
            var M,
              ...
              D = {};
            if (w > v)
              ((M = n.clone()).y -= 2 * t.fontsize.value()),
                (M.x = 0.5 * (i.x + n.x)),
                (D.points = [M]);
            else
              ((M = n.clone()).x = 0.5 * (i.x + n.x)),
            ...
            this._textRenderer.setPoints([k]),
              e.append(this._textRenderer),
              this.addAnchors(e),
              (this._renderer = e);
          }
        ...
        _updateImpl() {
          if (
            ...
            ((C = {}).points = [x, m]),
              ...
              (C.leftend = u.Normal),
              (C.rightend =
                Math.abs(x.y - m.y) >= 15 * C.linewidth ? u.Arrow : u.Normal),
            ...
            var P,
              ...
              C = {};
            if (b > y)
              ((P = o.clone()).y -= 2 * t.fontsize.value()),
                (P.x = 0.5 * (s.x + o.x)),
                (C.points = [P]);
            else
              ((P = o.clone()).x = 0.5 * (s.x + o.x)),
      ...
      class u extends n.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          c.lineBeingCreated() === n && _.pop(),
            e.append(this.createLineAnchor({ points: _ })),
            (this._renderer = e);
        }
        _initRenderers() {
          const e = this._getSource(),
            ...
            if (this._secondPoint && this._points.length > 0) {
              ...
              if (
                ...
                var M = this._source.properties().statsPosition.value(),
                  I = this._source.getPointByPosition(
                    M,
                    S.points[0],
                    this._middlePoint,
                    S.points[1],
        ...
        hitTest(e, t) {
          ...
          if (4 === i.points.length) {
            ...
            if (
              ...
              Object(o.a)(s, l, _, g, e, t) ||
              Object(o.c)(l, n, f, e, t)
            )
              return new a.HitTestResult(a.HitTestResult.MOVEPOINT);
    ...
    aB9a: function (e, t, i) {
      ...
      class w {
        ...
        draw(e, t) {
          ...
          i.length &&
            ((e.strokeStyle = this._data.color),
            this._drawPoints(e, t.pixelRatio, i, r, g, p)),
            n.length &&
              ((e.strokeStyle = this._data.color),
              this._drawPoints(e, t.pixelRatio, n, s, v, f));
        }
        hitTest(e) {
        ...
        _drawPoints(e, t, i, r, n, s) {
          ...
          for (let c = 0; c < i.length; ++c) {
            ...
            if (
              !(
                Object(h.isInteger)(f.data) &&
                this._data.linePointBeingEdited === f.data
              )
            ) {
              n(
                e,
      ...
      class y {
        ...
        _lineAnchorColors(e) {
          const t = Object(x.ensureNotNull)(
      ...
      t.TimeCyclesPaneView = class extends n {
        ...
        _updateImpl() {
          if (
            ...
            if (0 !== o) {
              for (var g = Math.min(l.x, d.x), f = [], v = n; g > -c; v -= o)
            ...
            for (
              ...
              if (f.visible.value()) {
                ...
                var y = {
                  ...
                  b = new s();
                b.setData(y),
                  b.setHitTest(new o(o.MOVEPOINT, null, g)),
                  t.append(b);
                var R,
                  T = {
                    points: [x, m],
              ...
              if (this._medianPoint && this._modifiedBase) {
                ...
                for (var f = 0; f <= 8; f++) {
                  ...
                  if (v.visible.value()) {
                    ...
                    (T = new s()).setData(S),
                      T.setHitTest(new o(o.MOVEPOINT, null, f)),
                      e.append(T);
                  }
                }
                this.addAnchors(e), (this._renderer = e);
        ...
        _updateImpl() {
          ...
          if (1 === this._points.length) {
            ...
            (i.data = 0),
              (i.square = !0),
              t.append(
                this.createLineAnchor({ points: [i], pointsCursorType: d }),
              );
          }
          this._renderer = t;
        }
            ...
            if (((d.data = 0), i.push(d), 1 !== e.points.length)) {
              ...
              if (((p.data = 1), 2 !== e.points.length)) {
                ...
                (P = h(L, P)),
                  ...
                  (L = o(1, b / (2 * v)));
                var C =
                  (P = h(L, P)).y >= 0 ? new r(g.x, g.y) : new r(y.x, y.y);
                (C.data = 2), i.push(C);
        ...
        _updateImpl() {
          if (
            ...
            if (
              ...
              for (u = 1; u <= 7; u++) {
                (m = Math.round(w + L['hlevel' + u].coeff.value() * v)),
                  (g = h + L['vlevel' + u].coeff.value() * n);
                this._hfans.push(this._model.timeScale().indexToCoordinate(m)),
                  this._vfans.push(
                    this._source.priceScale().priceToCoordinate(g, c),
                  );
              }
            var b = new l();
            if (this._points.length < 2)
            ...
            for (u = 0; u < this._vlevels.length; u++) {
              ...
              if (
                ((z = new o()).setData(B), b.append(z), L.showTopLabels.value())
              ) {
                var j = {
                  points: [e],
      ...
      t.RotatedRectanglePaneView = class extends s {
        ...
        _updateImpl() {
          if (
            ...
            l.append(this.createLineAnchor({ points: m, pointsCursorType: y })),
              (this._renderer = l);
          }
        }
        renderer(e, t) {
      ...
      class p extends u.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          if (
            ...
            1 === o.points.length && !this._noSelection)
          ) {
            ...
            if (o.wordWrapWidth) {
              ...
              (i.data = 0),
                e.append(
                  this.createLineAnchor({ points: [i], pointsCursorType: _ }),
                );
            }
        ...
        _statLabelData() {
          ...
          if (u.showPriceRange.value() && this._source.priceScale()) {
            ...
            e =
              this._source.ownerSource().formatter().format(r) +
              ' (' +
              this._percentageFormatter.format(100 * p) +
              ')';
          ...
          if (T || y) {
            ...
            (s = this._source.pointToScreenPoint(h)[0].subtract(S)),
              (a = Math.round(1e5 * s.length()) / 1e5);
          }
          if (x || m || y) {
            if (
              ((t = ''),
            ...
            y &&
              ...
              (t += $.t('distance: {0} px').format(
                b(this._numericFormatter.format(Math.round(a))),
              ))),
              t && _.push('barsRange');
          }
          T &&
            (a > 0 &&
              ((s = s.normalized()), (w = Math.acos(s.x)), s.y > 0 && (w = -w)),
            'number' != typeof w ||
              TradingView.isNaN(w) ||
      ...
      t.SineLinePaneView = class extends n {
        ...
        _updateImpl() {
          if (
            ...
            if (0 !== s) {
              for (
                var g = p.indexToCoordinate(n), f = [], v = n;
                g > -d;
                v -= s
              )
                (g = p.indexToCoordinate(v)), f.push(g);
              g = g = p.indexToCoordinate(n + s);
              for (v = n + s; g < p.width(); v += s)
                (g = p.indexToCoordinate(v)), f.push(g);
              for (var w = 0; w < f.length; w++) {
                var x = {
                    point: new r(f[w], o.y),
            ...
            if (i) {
              ...
              if (
                ...
                var o = new h(),
                  ...
                  v = this._points[g.ActualEntry]
                    ? this._points[g.ActualEntry].x
                    : this._points[g.Close].x,
                  x = this._points[g.ActualClose]
                ...
                if (
                  ...
                  (y = new r(v, this._entryLevel)),
                    (b = new r(x, this._closeLevel));
                  ((L = {}).points = [y, b]),
                    (L.color = 'white'),
                    (L.linewidth = 0),
                    (L.backcolor = d.stopBackground.value()),
                  ...
                  var R =
                    ...
                    100 *
                      (1 -
                        (T = 0.01 * d.stopBackgroundTransparency.value()) *
                          T *
                          T);
                  (L.transparency = R),
                    (L.extendLeft = !1),
                ...
                if (
                  ...
                  var T,
                    S =
                      ...
                      100 *
                        (1 -
                          (T = 0.01 * d.profitBackgroundTransparency.value()) *
                            T *
                            T);
                  (L.transparency = S),
                    (L.extendLeft = !1),
                ...
                (y = new r(c, this._points[g.Entry].y)),
                  (b = new r(m, this._points[g.Entry].y));
                ...
                var H =
                  Math.round((d.qty.value() / d.lotSize.value()) * 100) / 100;
                if (d.compact.value())
                  (z += j ? j + ' ~ ' : ''), (z += H + '\n'), (z += V);
                else {
                ...
                this._pl < 0
                  ? (F = d.stopBackground.value())
                  : this._pl > 0 && (F = d.profitBackground.value()),
                  C(this._middleLabelRenderer, E, z, F, 'middle', 0, 'white');
                (y = new r(c, this._stopLevel)),
                  (b = new r(m, this._stopLevel));
                ...
                (z = d.compact.value()
                  ...
                  C(
                    ...
                    E,
                    z,
                    d.stopBackground.value(),
                    M < I ? 'bottom' : 'top',
                    0,
                  );
                (y = new r(c, this._profitLevel)),
                  (b = new r(m, this._profitLevel));
    ...
    wacn: function (e, t, i) {
      ...
      function v(e, t) {
        const [i, r] = t.points;
        return (
          t.extendleft || (e = f(e, i.x, r.x)),
          t.extendright || (e = f(e, r.x, i.x)),
          e
        );
      }
    },
      ...
      class d extends n.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          p.lineBeingCreated() === e && f.pop(),
            o.append(this.createLineAnchor({ points: f })),
            (this._renderer = o);
        }
        _initRenderers() {
          const e = this._getSource(),
                ...
                for (l = 1; l < this._levels.length; l++) {
                  var f = this._levels[l - 1],
                    v =
                      ...
                      new r(f.x, this._source.priceScale().height())),
                    w = {};
                  (w.points = [e, v]),
    ...
    xiOp: function (e, t, i) {
      ...
      class h extends l.ScaledPaneRenderer {
        ...
        hitTest(e) {
          ...
          return Object(a.pointInBox)(e, Object(r.box)(s, l))
            ? new o.HitTestResult(o.HitTestResult.MOVEPOINT)
            : null;
        }
        setData(e) {
