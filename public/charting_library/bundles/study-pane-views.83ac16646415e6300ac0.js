    ...
    Gj0v: function (e, t, i) {
                ...
                (s.bars.forEach((o) => {
                  ...
                  if (l.showValues)
                    for (let e = 0; e < o.subBarValues.length; e++)
                      r[e] = (r[e] || 0) + o.subBarValues[e];
                  const c = g(s.xRange, l, t.cssWidth),
                    { xBasePoint: d, sign: u } = c,
                    p = f(n, n + o.height);
                  if (((n += o.height), p.min > t.cssHeight || p.max < 0))
                    return;
                  const R = Math.max(
      ...
      function g(e, t, i) {
        ...
        if (s && n) (o = e.min), (l = 1);
          ...
          if (!r || !a)
            throw new Error(
              `Unknown location/direction values: ${t.location}/${t.direction}`,
            );
          (o = i), (l = -1);
        }
      ...
      class b {
        ...
        _prepareStyles() {
          const e = Object(s.ensureDefined)(
          ...
          for (const r of t) {
            const t = Object(s.ensureDefined)(i.child(r)),
              ...
              a = Object(x.generateColor)(
                t.colors[0].value(),
                t.transparencies[0].value(),
              ),
              o = t.colors[1]
                ? Object(x.generateColor)(
                    t.colors[1].value(),
                    t.transparencies[1].value(),
                  )
                : a;
          ...
          this._prepareStyles(),
            Object(s.ensureDefined)(i).forEach((i, s) => {
              let r = 1 / 0,
                o = -1 / 0;
              i.forEach((e) => {
                (r = Math.min(r, e.firstBarTime)),
                  (o = Math.max(o, e.lastBarTime));
              }),
