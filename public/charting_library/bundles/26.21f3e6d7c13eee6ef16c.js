    ...
    AnDN: function (e, t, n) {
      ...
      function p(e) {
        ...
        return r.a.createElement(b.a, {
          className: c()(f.icon, t && f.dropped),
          icon: h,
        });
      }
      function m(e) {
        ...
        const {
          ...
          I =
            ...
            r.a.createElement(
              d.b,
              null,
              r.a.createElement(m, { isDropped: j, disabled: v }),
            );
        return r.a.createElement(
          r.a.Fragment,
          null,
    ...
    PECq: function (e, t, n) {
      ...
      function f(e, t, n, o, l, r) {
        ...
        return (function (e) {
          ...
          (s = null != s ? s : r.getBoundingClientRect()),
            (a = null != a ? a : i.getBoundingClientRect());
      ...
      function N(e) {
        ...
        if (!l)
          return r.a.createElement(
            'span',
            { className: c()(x.placeholder, o && x.hiddenArrow) },
            i,
          );
        const s =
          null !==
        ...
        return r.a.createElement(
          'span',
          { className: c()(x.selected, o && x.hiddenArrow) },
          s,
        );
      }
      n.d(t, 'a', function () {
      ...
      const _ = r.a.forwardRef((e, t) => {
        ...
        if (x) {
          I = [
            { value: void 0, content: x, id: Object(a.a)(n, 'placeholder') },
            ...I,
          ];
        }
        const {
          ...
          P = (function (e) {
            ...
            return (
              Object(l.useEffect)(
                () => (
                  (t.current = new p(e)),
                  () => Object(s.ensureNotNull)(t.current).destroy()
                ),
                [],
              ),
              t
        ...
        return r.a.createElement(
          ...
          Object.assign({}, F, J, {
            ...
            scrollWrapReference: function (e) {
              (Q.current = e),
                Object(s.ensureNotNull)(P.current).setContainer(e);
            },
            ...
            buttonChildren: r.a.createElement(N, {
              hideArrowButton: f,
              selectedItem: Z,
              placeholder: x,
            }),
            ...
            (e) => {
              t && (t.current = e),
                s.CheckMobile.iOS() &&
                  ...
                  (a.current = e),
                  null !== a.current &&
                    Object(i.disableBodyScroll)(a.current, {
                      allowTouchMove: u(a),
                    }));
            },
            [t],
      ...
      function s(e) {
        const {
          ...
          j = Object(o.useCallback)(
            () => Object(l.ensureNotNull)(v.current).focus(),
            [v],
          ),
          C = Object(o.useRef)(null),
          w = Object(o.useCallback)(
            () => Object(l.ensureNotNull)(C.current).focus(),
            [C],
          ),
