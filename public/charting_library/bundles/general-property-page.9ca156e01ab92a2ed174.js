  ...
  ['general-property-page'],
  {
    ...
    '5lPo': function (e, t, i) {
      ...
      function f(e, t, i, s, n) {
        ...
        null !== b &&
          l.push(Object(a.l)([b], 'sellBuyButtonsLegendVisibilityGroup'));
        const g = [],
          f = Object(a.c)(
            {
              checked: Object(a.b)(
      ...
      function be() {
        ...
        return se.a.map((t) => ({
          value: t,
          title: new ne.DateFormatter(t).format(e),
        }));
      }
      const pe = [
        {
      ...
      class ge {
        ...
        _createSeriesViewModel() {
          const e = {
            ...
            values: oe.availableTimezones.map((e) => ({
              value: e.id,
              title: e.title,
            })),
          };
        ...
        _createScalesDefinitions() {
          const e = this._chartWidgetProperties
            ...
            t = {
              ...
              values: Object(
                h.allPriceScaleSelectionStrategyInfo,
              )().map((e) => ({ value: e.name, title: e.title })),
            },
            ...
            const w = Object(a.j)(
              ...
              y = Object(a.k)(
                ...
                },
                {
                  id: 'scalesPlacement',
                  title: R,
                  options: new o.a(s.scalesPlacementPropertyObj.values),
                },
              );
            if ((l.push(w, y), r.enabled('scales_date_format'))) {
              const t = Object(a.k)(
                ...
                },
                {
                  id: 'dateFormat',
                  title: G,
                  options: new o.a(s.dateFormatPropertyObj.values),
                },
              );
              l.push(t);
            }
        ...
        _createAppearancePropertyPage() {
          ...
          const g = Object(s.ensureNotNull)(this._maxRightOffsetPropertyObject),
            w = (function (e, t, i, s, n, l, c, d, h) {
              ...
              const S = Object(a.j)(
                  {
                    value: Object(a.b)(e, t.topMargin, 'Change Top Margin', [
                      _.b,
                    ]),
                  },
                  {
                ...
                L = Object(a.j)(
                  {
                    value: Object(a.b)(e, c.property, 'Change Right Margin', [
                      _.b,
                    ]),
                  },
                  {
    ...
    RspR: function (e, t, i) {
      ...
      var s = i('+jnJ'),
        r = i('1ANp');
      const { property: n, availableValues: o, actualBehavior: a } = Object(
        s.b,
      )('PaneButtons.visibility', r.c);
    },
    WS5G: function (e, t) {
      e.exports =
