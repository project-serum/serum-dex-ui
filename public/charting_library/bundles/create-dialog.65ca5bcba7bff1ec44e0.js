      ...
      (function () {
        ...
        (v.each = v.forEach = function (t, e, n) {
          ...
          (v.find = v.detect = function (t, e, n) {
            ...
            if (
              void 0 !==
                (r = k(t) ? v.findIndex(t, e, n) : v.findKey(t, e, n)) &&
              -1 !== r
            )
              return t[r];
          }),
          ...
          (v.every = v.all = function (t, e, n) {
            e = y(e, n);
            for (
              var r = !k(t) && v.keys(t), i = (r || t).length, o = 0;
              o < i;
              o++
            ) {
              var s = r ? r[o] : o;
          ...
          (v.max = function (t, e, n) {
            ...
            if (null == e && null != t)
              for (
                var a = 0, u = (t = k(t) ? t : v.values(t)).length;
                a < u;
                a++
              )
                (r = t[a]) > o && (o = r);
        ...
        function I(t, e, n) {
          return function (r, i, o) {
            ...
            if (i != i)
              return (o = e(l.call(r, s, a), v.isNaN)) >= 0 ? o + s : -1;
        ...
        (v.flatten = function (t, e) {
          ...
          (v.intersection = function (t) {
            for (
              var e = [], n = arguments.length, r = 0, i = C(t);
              r < i;
              r++
            ) {
              var o = t[r];
          ...
          (v.unzip = function (t) {
            for (
              var e = (t && v.max(t, C).length) || 0, n = Array(e), r = 0;
              r < e;
              r++
            )
              n[r] = v.pluck(t, r);
        ...
        (v.keys = function (t) {
          ...
          (v.values = function (t) {
            for (
              var e = v.keys(t), n = e.length, r = Array(n), i = 0;
              i < n;
              i++
            )
              r[i] = t[e[i]];
        ...
        var O = function (t, e, n, r) {
          ...
          if ((n.push(t), r.push(e), o)) {
            ...
            for (; u--; )
              if (((l = h[u]), !v.has(e, l) || !O(t[l], e[l], n, r))) return !1;
          }
                  ...
                  'getInstance' === i
                    ...
                    : $(this).each(function () {
                        var o = $(this),
                          s = o.data(t);
                        void 0 === s &&
                          ((s = void 0 === u ? e(o) : e(o, u)), o.data(t, s)),
                          'init' !== i &&
                            ('function' == typeof s[i]
                              ? n(s, i, u)
                              : r.logError(
