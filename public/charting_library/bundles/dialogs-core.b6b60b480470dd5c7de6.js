(window.webpackJsonp = window.webpackJsonp || []).push([
  ['dialogs-core'],
  {
    ...
    APlX: function (t, s, i) {
      ...
      (function (t) {
        ...
        const u = {
          ...
          ajaxErrorTemplate: `<div class="tv-dialog__error js-dialog__close">${window.t(
            'Error',
          )}</div>`,
        };
        class g extends r.TVDialogAbstract {
            ...
            if (
              ...
              this.on('change:zIndex', () => {
                this.$overlay.css('z-index', this.zIndex),
                  this.$modalWrap.css('z-index', this.zIndex);
              }),
              this.on('destroy', () => {
                const t = () => {
                ...
                this.opened
                  ? (this.close(), setTimeout(t, this.options.closingDuration))
                  : t();
              }),
              this.on('beforeOpen', () => {
                p.push(this);
              ...
              $.extend(this.options.ajax, {
                beforeSend: () => {
                  this.trigger('beforeLoading', [this]),
                    this.startSpinner(),
                    t(this);
                },
                success: (t) => {
                ...
                error: () => {
                  this.renderContent(this.options.ajaxErrorTemplate),
                    i(this),
                    this.trigger('errorLoading', [this]);
                },
              });
            }
            this.on('error', (t, s) => {
              this.$modalWrap[0].getBoundingClientRect().height <
          ...
          open() {
            ...
            const t = () => {
              this.focus(),
                ...
                this.options.ajax.url
                  ? (this.ajaxRequest = $.ajax(this.options.ajax))
                  : this.showContent();
            };
          ...
          hideContent() {
            if (this.$el)
              return this.$modalWrap.addClass('i-closed'), this.unfocus(), this;
          }
          startSpinner() {
            return (
              (this.spinner = new l.Spinner('large')),
    ...
    PzOn: function (t, s, i) {
      ...
      $.fn.tvButtonLoader = Object(e.createTvBlockWithInstance)(
        'tv-button-loader',
        function (t) {
          return new a(t);
        },
      ...
      class g extends a.TVDialogAbstract {
          ...
          super(e({}, u, t)),
            ...
            this.$scrollWrap.length
              ...
              : ((this.$scrollWrap = this.$content
                  .wrap($(this.options.scrollWrap))
                  .parent()),
                (this.$scrollWrapInner = this.$content
                  .wrap($(this.options.scrollWrapInner))
                  .parent())),
            this.$actions && this.$scrollWrap.addClass('i-with-actions'),
            this.options.withScroll &&
              ((this.scroll = new r.SidebarCustomScroll(
                this.$scrollWrap,
                this.$scrollWrapInner,
              )),
              this.scroll.scrolled.subscribe(null, () =>
                this.trigger('scroll'),
              )),
                ...
                setTimeout(() => {
                  this.opened &&
                    ...
                    $(document).on('click.tv-popup-' + s, (t) => {
                      ...
                      (this.options.closeOnClickAtOtherDialogs ||
                        0 === s.length) &&
                        this.isEventOut(t) &&
                        this.close();
                    }));
        ...
        fixPos() {
          ...
          t.bottom > n.mediaState.height - 10 &&
            ((s.top = n.mediaState.height - 10 - t.height),
            s.top < 10 && (s.top = 10)),
            t.right > n.mediaState.width - 10 &&
              ((s.left = n.mediaState.width - 10 - t.width),
              s.left < 10 && (s.left = 10)),
        ...
        calcHeight() {
          ...
          let e =
            this.options.height &&
            this.options.height < n.mediaState.height - 20
              ? this.options.height
      ...
      (function (t, e) {
        ...
        const u = $(document),
          g = {
            ...
            closeButtonTemplate: `<div class="tv-dialog__close js-dialog__close">${i(
              'uo4K',
            )}</div>`,
            helpButtonTemplate:
        ...
        class _ extends r.default {
          constructor(s = {}) {
            if (
              (super(),
              (this.manager =
                s.manager || (0, l.getRootOverlapManager)(s.ownerDocument)),
              (this._id = c++),
              (this.loadingActions = []),
              ...
              (this.options = o({}, g, s)),
              (this.$el = $(
                t.render(this.options.template, {
            ...
            for (
              this.options.addClass && this.$el.addClass(this.options.addClass),
                ...
                this.options.title &&
                  (this.$title = $(
                    t.render(this.options.titleTemplate, {
                      title: this.options.title,
                    }),
                  ).appendTo(this.$el)),
                this.$content = $(this.options.contentWrapTemplate).appendTo(
                  this.$el,
                ),
            ...
            if (
              ...
              (this.options.actions || this.options.help) &&
                ...
                (this.$actions = $(this.options.actionsWrapTemplate).appendTo(
                  this.$el,
                ))),
              ...
              (this.actions = {}),
                this.$el.on(
                  ...
                  (t) => {
                    t.preventDefault(),
                      this.actionDispatcher($(t.currentTarget).data('name'));
                  },
                );
                ...
                if (
                  ...
                  (this.actions[i.name] = t.$el.appendTo(this.$actions)),
                    this.actions[i.name].on('change', () => {
                      setTimeout(() =>
                        this.actionDispatcher(i.name, t.checked),
                      );
                    });
                } else
                  this.actions[i.name] = $(
                    t.render(
                      i.template ? i.template : v[i.type] || v._default,
                      i,
                      i,
                    ),
                  ...
                  if ('string' == typeof i.key && i.key.split('+').length > 1) {
                    ...
                    const o = (t) => {
                      ...
                      -1 !== e.indexOf(o) && s.indexOf(o) && s.push(o),
                        this._focused &&
                          s.length === e.length &&
                          ((s = []), this.actionDispatcher(i.name));
                    };
                    this.on('afterOpen', () => {
            ...
            if (
              (this.options.help &&
                $(
                  t.render(this.options.helpButtonTemplate, this.options.help),
                ).prependTo(
              ...
              let s = this.$el;
              1 === this.$el.find('.js-close-button-place').length &&
                (s = this.$el.find('.js-close-button-place')),
                t.appendTo(s);
            }
          ...
          renderContent(t) {
            return (
              this.$contentIn.html('function' == typeof t ? t(this) : t), this
            );
          }
          setDestroyOnClose(t) {
          ...
          setZIndex(t) {
            return (
              (this.zIndex = t), this.trigger('change:zIndex', [this]), this
            );
          }
          toTop() {
            for (let t = p.length - 1; t >= 0; t--)
              p[t].zIndex > this.zIndex && p[t].setZIndex(p[t].zIndex - 1);
            return (
              this.setZIndex(110 + p.length),
          ...
          isEventOut(t) {
            ...
            return (
              ...
              ($('>*', this.$el).each(function () {
                i.get(0) === $(this).get(0) && (s = !1),
                  0 === i.closest('HTML', $(this).get(0)).length && (s = !1);
              }),
              s)
            );
          }
            ...
            d && d !== this && d.unfocus(),
              ...
              setTimeout(() => {
                u.on('mousedown.tv-dialog-unfocus-' + this._id, (t) => {
                  this.isEventOut(t) &&
                    (this.unfocus(),
                    u.off('mousedown.tv-dialog-unfocus-' + this._id));
                });
              }, 20);
          }
          _setFocused() {
          ...
          toggleAction(t, s) {
            return (
              s || this.disabledActions.includes(t)
                ? s &&
                  this.disabledActions.includes(t) &&
                  (this.disabledActions = e.without(this.disabledActions, t))
          ...
          error(s) {
            ...
            return (
              ...
              u.one('touchstart mousedown keydown', () => {
                i.addClass('i-slided'),
                  setTimeout(() => i.remove(), 0.75 * n.dur);
              }),
