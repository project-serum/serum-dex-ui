    ...
    '4Cm8': function (t, e, s) {
      ...
      function p(t) {
        return i.createElement('div', {
          className: r(u.fadeLeft, { [u.isVisible]: t.isVisible }),
        });
      }
      function f(t) {
        return i.createElement('div', {
          className: r(u.fadeRight, { [u.isVisible]: t.isVisible }),
        });
      }
      function w(t) {
        return i.createElement(
          m,
          Object.assign({}, t, { className: u.scrollLeft }),
        );
      }
      function b(t) {
        return i.createElement(
          m,
          Object.assign({}, t, { className: u.scrollRight }),
        );
      }
      function m(t) {
        return i.createElement(
          'div',
          {
            className: r(t.className, { [u.isVisible]: t.isVisible }),
            onClick: t.onClick,
          },
          i.createElement(
            'div',
            { className: u.iconWrap },
            i.createElement(n.a, { icon: c, className: u.icon }),
          ),
        );
      }
        ...
        return (
          ((c = class extends i.PureComponent {
            ...
            animateTo(t, e = a.dur) {
              ...
              s &&
                (Object(h.isRtl)() &&
                  (t = Object(h.getLTRScrollLeftOffset)(s, t)),
                e <= 0
