  ...
  ['symbolsearch'],
  {
            ...
            return (
              ...
              (m.bindToInput = function (t, i) {
                ...
                T &&
                  ...
                  b() &&
                  (i.ignoreInterval ||
                    ((E = m.getInputValueGetter(t.get(0))),
                    (I = m.getInputValueSetter(t.get(0)))),
              ...
              (m.detachStoreInterval = function (t) {
                ...
                return e
                  ? ((A = e.detached), (D = _.normalize(A)), e.rest)
            ...
            function o() {
              i.removeClass(e.settings.customPrependSelectorClass),
                e._lastSelectorPrepend &&
                  (e._lastSelectorPrepend.remove(),
                  delete e._lastSelectorPrepend),
                n.data('custom-option-prepend') &&
                  (e.settings.customPrependSelectorClass &&
                    i.addClass(e.settings.customPrependSelectorClass),
                  (e._lastSelectorPrepend = t(
                    n.data('custom-option-prepend'),
                  ).clone()),
                  i[e.settings.useCustomPrependWithSelector](
                    e._lastSelectorPrepend,
                  ));
            }
            e.settings.useCustomPrependWithSelector &&
              (s ? (e._onAttachCallback = o) : o());
          }
          t.extend(i.prototype, {
            ...
            _attachSelectbox: function (e, i) {
                ...
                l.children().each(function (n) {
                  ...
                  if (t(this).is(':selected')) {
                    if (38 == i && n > 0)
                      return (
                        (s = t(l.children()[n - 1])),
                        c._changeSelectbox(e, s.val(), s.text()),
                        !1
                      );
              ...
              d && s.css(d),
                ...
                s.insertAfter(l),
                p._onAttachCallback &&
                  (p._onAttachCallback(), delete p._onAttachCallback),
            ...
            _changeSelectbox: function (e, i, o) {
              ...
              if (
                ...
                p.text(o),
                  ...
                  c.attr('selected', !0),
                  l
                    ? l.apply(a.input ? a.input[0] : null, [i, a])
            ...
            _optionSelectbox: function (e, i, n) {
              ...
              return (
                ...
                (null == n
                  ? s[i]
                  : ((s[i] = n), void t.data(e, 'selectbox', s)))
              );
            },
                  ...
                  'object' == typeof g && null !== g
                    ...
                    : (d > 50 && !i.settings.slidesUp
                        ...
                        : r.css({
                            top: 'auto',
                            bottom: u + 2 + 'px',
                            maxHeight: c.top - p - u / 2 + 'px',
                          }),
                      c.left + r.width() > l
                        ? r.css(
                            'left',
                            '-' + (r.width() - r.parent().width() + 3) + 'px',
                          )
                        : r.css('left', '-1px')),
                  'fade' === i.settings.effect
                    ? r.fadeIn(i.settings.speed)
                    : r.slideDown(i.settings.speed),
                  s
                    .find('#sbToggle_' + i.uid)
                    .addClass(i.settings.classToggleOpen),
                  s
                    .find('#sbHolder_' + i.uid)
                    .addClass(i.settings.classHolderOpen),
                  (this._state[i.uid] = !0),
                  (i.isOpen = !0),
            ...
            _getOptions: function (e, i, n, o, r) {
              ...
              arguments[0].each(function (e) {
                var i,
                  ...
                  u = t('<li>');
                p.is(':selected') &&
                  (n.sbSelector.text(p.text()),
                  s(n, n.sbSelector, p, !0),
                  (n.isSelected = !0)),
                    ...
                    '__separator__' === p.val()
                      ...
                      : ((i = t('<a>', {
                          ...
                          click: function (i) {
                            ...
                            s.attr('id').split('_')[1];
                            c._closeSelectbox(r),
                              c._changeSelectbox(r, t(this).attr('rel'), e),
                              s.focus();
                          },
                        })),
            ...
            _fillList: function (e, i, n) {
              ...
              n || (n = 0),
                ...
                i.isSelected ||
                  (i.sbSelector.text(a.first().text()),
                  s(i, i.sbSelector, a.first(), !0),
                  (i.isSelected = !0));
            },
          }),
    ...
    w3Pp: function (t, e, i) {
      ...
      function l(t, e = []) {
        ...
        const p = Boolean(e.length)
          ? Object(n.t)(t, o) + ' ' + i.join(' ')
          : r[t] || t;
        return s.set(l, p), p;
      }
    },
