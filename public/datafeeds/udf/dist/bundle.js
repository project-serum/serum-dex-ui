  ...
  var d =
    ((h.prototype.resolveSymbol = function (t, r) {
      ...
      return this._readyPromise.then(function () {
        var e = s._symbolsInfo[p(t, r)];
        return void 0 === e
          ? Promise.reject('invalid symbol')
          : Promise.resolve(e);
      });
    }),
    (h.prototype.searchSymbols = function (i, n, a, u) {
      var c = this;
      return this._readyPromise.then(function () {
        var s = [],
          o = 0 === i.length;
        ...
        for (var o = r.symbol.length, i = void 0 !== r.ticker; s < o; ++s) {
          var n = r.symbol[s],
            ...
            h = {
              ...
              exchange: u,
              currency_code: l,
              original_currency_code: f(r, 'original-currency-code', s),
              description: f(r, 'description', s),
              has_intraday: _(f(r, 'has-intraday', s), !1),
              has_no_volume: _(f(r, 'has-no-volume', s), !1),
              ...
              supported_resolutions: _(
                f(r, 'supported-resolutions', s, !0),
                e._datafeedSupportedResolutions,
              ),
              force_session_rebuild: f(r, 'force-session-rebuild', s),
              has_daily: _(f(r, 'has-daily', s), !0),
              intraday_multipliers: _(f(r, 'intraday-multipliers', s, !0), [
                '1',
                '5',
                '15',
                '30',
              ...
              volume_precision: _(f(r, 'volume-precision', s), 0),
              format: 'price',
            };
          (e._symbolsInfo[d] = h),
            (e._symbolsInfo[n] = h),
            (e._symbolsInfo[c] = h),
            void 0 !== l &&
              ((e._symbolsInfo[p(d, l)] = h),
              (e._symbolsInfo[p(n, l)] = h),
              (e._symbolsInfo[p(c, l)] = h)),
