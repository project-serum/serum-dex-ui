(window.webpackJsonp = window.webpackJsonp || []).push([
  ['chart-widget-gui'],
  {
    ...
    RspR: function (t, e, i) {
      ...
      var s = i('+jnJ'),
        l = i('1ANp');
      const { property: o, availableValues: n, actualBehavior: a } = Object(
        s.b,
      )('PaneButtons.visibility', l.c);
    },
    S48P: function (t, e) {
      t.exports =
    ...
    TGRH: function (t, e, i) {
      ...
      class k {
        ...
        _initHandlers() {
          ...
          for (const s of e)
            this._buttons.moveLeft.addEventListener(s, () =>
              this._chart.scrollHelper().stopMoveByBar(),
            ),
              this._buttons.moveRight.addEventListener(s, () =>
                this._chart.scrollHelper().stopMoveByBar(),
              );
    ...
    lvAK: function (t, e, i) {
      ...
      class c {
        constructor(t, e, i) {
          ...
          for (const [s, l] of Object.entries(this._actions)) {
            ...
            (this._actionsSpawns[t] = {
              ...
              this._actionsSpawns[t].visible.subscribe(
        ...
        updateWidgetModeByWidth(t) {
          ...
          s.classList.toggle(u.blockHidden, e || i),
            l.classList.toggle(
              u.blockHidden,
              e || !i || !this._actions.more.visible.value(),
            );
        }
        _render() {
          this._renderActions(),
        ...
        _renderActions() {
          ...
          for (const e of Object.keys(this._listActionsElements))
            Object(o.ensureNotNull)(this._listActionsElements[e]).classList.add(
              h.newButton,
            );
        ...
        _updateActionTitle(t, e) {
          Object(o.ensureNotNull)(this._listActionsElements[t]).setAttribute(
            'title',
            e,
          );
        }
        ...
        _updateThemedColor(t) {
          if (t.length > 0) {
            ...
            this._parentEl.style.color = Object(n.rgbaToString)([
              e,
              i,
              s,
              Object(n.normalizeAlphaComponent)(0.8),
            ]);
      ...
      class I {
        ...
        _getCloseButtonVisibility() {
          ...
          return (
            t.containsMainSeries() ||
              t.isMaximized() ||
              W ||
              (e = t.dataSources().some((t) => Object(l.isStudy)(t))),
            e
          );
        }
        _onCloseButton() {
        ...
        _getUpButtonVisibility() {
          const t = this._paneWidget.state();
          return (
            this._model.model().panes().indexOf(t) > 0 && !t.isMaximized() && !W
          );
        }
        ...
        _getMaximizeButtonVisibility() {
          const t = this._paneWidget.state();
          return (
            this._model.model().panes().length > 1 && !t.isMaximized() && !W
          );
        }
    ...
    sAH5: function (t, e, i) {
      ...
      class M {
        constructor(t, e, i) {
          ...
          (this._values = this._model.values().spawn()),
            ...
            (this._actionsSpawnArray = this._model.actions().map((t) => ({
        ...
        destroy() {
          ...
          if (
            ...
            Object(s.ensureNotNull)(this._el.parentNode).removeChild(this._el),
              (this._el = null);
          }
        }
        getHeight() {
        ...
        _render() {
          this._renderTitle(),
            ...
            this._firstBlockWrapper.appendChild(
              Object(s.ensureNotNull)(this._titleParentEl),
            ),
            null !== this._actionsParentEl &&
        ...
        _renderTitle() {
          ...
          for (let e = 0; e < this._titlesSpawns.length; e++) {
            ...
            i.classList.add(m.title, f[e], 'apply-overflow-tooltip'),
        ...
        _updateTitlesHandler(t, e) {
          const i = Object(s.ensureNotNull)(this._titleElements[t]),
            l = 0 === e.length;
          i.classList.toggle(w.blockHidden, l),
            i.classList.toggle(m.withDot, !l),
            S(i, e);
        }
        _updateStates(t) {
        ...
        _updateValuesHTMLElHandler(t, e) {
          S(Object(s.ensure)(this._valuesElements[t].value), e),
            this._updateShowValues();
        }
        ...
        _updateValueVisibleHandler(t, e) {
          const i = Object(s.ensure)(this._valuesElements[t].value).closest(
            '.' + m.valueItem,
          );
        ...
        _updateShowLine() {
          null !== this._el &&
            this._el.classList.toggle(w.blockHidden, this._isRowHidden.value());
        }
        _createValuesSpawns() {
        ...
        _removeValuesSpawnsSubscriptions() {
          for (const t of this._valuesSpawnArray)
            t.value.destroy(), t.color.destroy(), t.visible.destroy();
        ...
        _addStatusesWidget(t, e, i) {
          (this._statusesWrapper = document.createElement('div')),
            ...
            Object(s.ensureNotNull)(this._firstBlockWrapper).appendChild(
        ...
        _updateCustomTextColor() {
          ...
          for (const i of this._titleElements)
            null !== i && (i.style.color = t);
          const e = Object(s.ensureNotNull)(
            this._valuesParentEl,
          ).querySelectorAll('.' + m.valueTitle);
          for (let i = 0; i < e.length; i++) e[i].style.color = t;
          Object(s.ensureNotNull)(this._el).classList.toggle(
      ...
      class C extends M {
        ...
        _renderValues() {
          ...
          for (const i of e) {
            ...
            e.classList.add(m.valueItem),
              e.classList.toggle(w.blockHidden, !i.visible.value());
        ...
        _addValuesSpawnsSubscriptions() {
          ...
          for (let t = 0; t < this._valuesSpawnArray.length; t++)
            this._valuesSpawnArray[t].title.subscribe(
      ...
      class V extends M {
        ...
        _updateShowLine() {
          ...
          t
            ? this._el.classList.toggle(w.blockHidden, t)
        ...
        _render() {
          super._render();
          const t = Object(s.ensureNotNull)(this._el);
          t.classList.add(m.item, m.study),
      ...
      class N {
        ...
        addMainDataSource(t, e) {
          this._renderMainDataSourceEl(),
            (this._mainDataSourceRenderer = new C(
              t,
              Object(s.ensureNotNull)(this._mainDataSourceEl),
              {
        ...
        addDataSources(t, e) {
          ...
          const i = Object(s.ensureNotNull)(
          ...
          for (let s = 0; s < t.length; s++) {
            const l = t[s],
              o = new V(l, i, {
                ...
                hideInvisibleHover: z(e[s].visibleWidgetsCount, (t) =>
                  Boolean(t),
                ),
      ...
      class $ {
        ...
        _calcNewPosition(t) {
          ...
          if (t.hasOwnProperty('touches') && t.touches.length > 0)
            ...
            e = {
              clientX: Object(F.isRtl)() ? i.right : i.left,
      ...
      class nt extends $ {
        ...
        _symbolActionHandler() {
          null !== this._symbolMarker &&
            (this._updateSymbolMarker(), Ri('Change flag state'));
        }
        _updateSymbolMarker() {
      ...
      class Et extends $ {
        ...
        destroy() {
          super.destroy();
          const t = this._model.model().properties().paneProperties
            .legendProperties;
        ...
        _isSymbolLikeStudy() {
          return (
            this._source instanceof bt.study_Overlay ||
            this._source instanceof gt.a
          );
        }
      ...
      function Wt(t, e, i, s, l, o) {
        return (function (t, e, i, s, l) {
          ...
          if (void 0 !== n) {
            ...
            void 0 !== t &&
              t.length > 0 &&
              (o.push(...t), o.push(new Vt.Separator()));
          }
            ...
            e.showOpenMarketStatus &&
              o.push(
                new Vt.Action({
                  ...
                  onExecute: () =>
                    Tt(t, xt.b, 'Change open market status visibility'),
                }),
              );
          if (
            (o.push(
              new Vt.Action({
                ...
                onExecute: () =>
                  Tt(t, a.showSeriesOHLC, 'Change OHLC Values Visibility'),
              }),
            ),
            o.push(
              new Vt.Action({
                ...
                onExecute: () =>
                  Tt(t, a.showBarChange, 'Change Bar Change Visibility'),
              }),
            ),
      ...
      function qt(t) {
        ...
        e.includes(t) ||
          (e.push(t),
          Zt.setJSON('tv.alreadyBlinkedStatuses', e),
          Xt.setValue(Yt()));
      }
      ...
      window.t('Create a free account'),
        window.t('Learn more'),
        Object(Kt.b)(window.t('Fill out Exchange Agreements'));
      class Ve extends Gt {
        constructor(t, e, i) {
          super({
            iconMap: ne,
        ...
        setModel(t) {
          if ((this._dataUpdatedMode.destroy(), null === t))
            return (
              (this._model = t),
              void (this._dataUpdatedMode = new o.a(null).spawn())
            );
        ...
        async _getHtmls() {
          ...
          try {
            ...
            oe.logError(
              "Can't get exchange description, reason: " + Object(Jt.a)(o),
            );
          }
          for (const n of t)
            if (
              ...
              [
                ...
                null !== s &&
                  'DelayNoRealtime' === n &&
                  e[n].push(me.format({ description: `<b>${s}</b>` })),
                'DelayWithoutMarketAgreement' === n &&
                  e[n].push(
                    Ee.format({ listedExchange: this._model.listedExchange() }),
                  ),
                this._options.subscriptionFullInfo &&
                  [
                    'TFEXDelayForGuest',
                  ...
                  e[n].push(
                    be.format({ listedExchange: this._model.listedExchange() }),
                  )),
              'EOD' === n && (e[n] = [we]),
              'TickByTick' === n &&
              ...
              e[n].push(
                fe.format({ symbolName: i, exchange: l }),
                '' !== t ? Ce.format({ exchange: t }) : Me,
              );
            }
        ...
        _getShortTexts() {
          ...
          for (const i of t)
            if (
              ...
              e[i] =
                '' !== t
                  ? _e.format({ exchange: t, originalExchange: ce })
                  : ce;
            }
          return Object.keys(e).length > 0 ? e : null;
        }
        _updateBlinkingMode() {
          ...
          for (const i of t)
            if (!e.includes(i)) return void this.isBlinkingMode.setValue(!0);
      ...
      class Fe extends Gt {
        constructor(t, e) {
          super(e),
            (this._booleanStatus = new o.a(!1).spawn()),
            this.updateStatus(t);
        }
        destroy() {
      ...
      class Wi {
        constructor(t, e, i) {
          ...
          for (const s of this._tooltipSpawns)
            s.subscribe(this._updateTooltips.bind(this));
          for (const s of this._visibilitySpawns)
            s.subscribe(this._updateVisibleWidgetsCount.bind(this)),
              s.subscribe(this._updateTooltips.bind(this));
        ...
        _recreateWidgets() {
          ...
          if (this._options.sourceStatusesEnabled) {
            if (
              ...
              if (
                ((this._isSymbolInvalid = Object(Nt.a)(
                  e.isSymbolInvalid.bind(this._source),
                  e.onStatusChanged(),
                )),
          ...
          if (this._options.marketStatusEnabled) {
            ...
            if (null === this._marketStatusViewModel) {
              this._marketStatusViewModel = new Hi(
                t,
                this._size,
              ...
              const e = Object(Z.a)(
                () =>
                  ...
                  Object(s.ensureNotNull)(this._marketStatusViewModel)
                    .visible()
                    .value(),
          ...
          if (this._options.dataUpdateModeEnabled) {
            ...
            if (null === this._dataUpdatedModeViewModel) {
              this._dataUpdatedModeViewModel = new Ve(
                t,
                this._size,
              ...
              const e = Object(Z.a)(
                () =>
                  ...
                  Object(s.ensureNotNull)(this._dataUpdatedModeViewModel)
                    .visible()
                    .value(),
            ...
            if (null === this._dataProblemViewModel) {
              ...
              const e = Object(Z.a)(
                () =>
                  ...
                  Object(s.ensureNotNull)(this._dataProblemViewModel)
                    .visible()
                    .value(),
        ...
        constructor(t, e, i, s, l, a) {
          (this._mainSeriesViewModel = null),
            ...
            (this._dataSourceViewModelsOptions = Object.assign(
              Object.assign({}, this._mainSeriesViewModelsOptions),
          ...
          const h = this._model.model().properties().paneProperties
              .legendProperties.showBackground,
            u = new o.a(h.value());
          h.subscribe(this, () => {
            u.setValue(h.value());
          });
          const c = this._model.model().properties().paneProperties
          ...
          i > -1
            ? (t.splice(i, 1),
              Ni ||
                ...
                (this._mainSeriesStatusWidget = new Pi(
                  e,
                  this._model.model(),
          ...
          if (!this._wrapText.value() && this._availableHeight > 0 && t > 2) {
            ...
            if (null !== e && null !== i) {
              ...
              if (t > o + 1) {
                ...
                return (
                  this._collapsedDataSourcesTitle.setValue(e),
        ...
        _addCustomWidgetForLayerBlock(t) {
          ...
          for (const l of Array.from(e.keys())) {
            ...
            for (let e = o.length; e < n.length; e++) {
              ...
              0 === t &&
                0 === l &&
                i.setGlobalVisibility(this._hideNotMainSources.opposite()),
                o.push(i),
