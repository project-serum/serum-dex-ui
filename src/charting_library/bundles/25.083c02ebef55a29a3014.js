      ...
      function m(e) {
        ...
        return i.a.createElement(
          ...
          Object.assign({}, M, {
            ...
            role: o,
            'aria-selected': n,
            className: r(h, x.item, C && x.withIcon, {
              [x.isActive]: _,
              [x.isDisabled]: w || y,
              [x.hovered]: E,
            }),
            ...
            onMouseUp: function (t) {
              ...
              if (1 === t.button && S && o) {
                ...
                n && (e += '_mouseWheelClick'),
                  Object(c.trackEvent)(o.category, o.event, e);
              }
            },
            onMouseOver: P,
            onMouseOut: I,
          ...
          void 0 !== T &&
            i.a.createElement(
              'div',
              { onClick: p, className: r(x.toolbox, { [x.showOnHover]: N }) },
              T,
            ),
        );
        var B;
    ...
    V3OP: function (e, t, o) {
      ...
      function c() {
        const [e, t] = Object(n.useState)(
          Object(s.getJSON)('pickerCustomColors', []),
        );
        r('add_new_custom_color', (o) => t(l(o, e))),
          r('remove_custom_color', (o) => t(u(o, e)));
        const o = Object(n.useCallback)(
            (t) => {
              ...
              e.some(
                (e) =>
                  null !== e &&
                  null !== o &&
                  Object(a.areEqualRgb)(Object(a.parseRgb)(e), o),
              ) ||
                (i.emit('add_new_custom_color', t),
                Object(s.setJSON)('pickerCustomColors', l(t, e)));
            },
            [e],
          ),
          c = Object(n.useCallback)(
            (t) => {
              (t >= 0 || t < e.length) &&
                (i.emit('remove_custom_color', t),
                Object(s.setJSON)('pickerCustomColors', u(t, e)));
            },
            [e],
          );
        return [e, o, c];
          ...
          return s.createElement(
            ...
            e.map((e, t) =>
              s.createElement(g, {
                ...
                color: e,
                selected:
                  n && Object(c.areEqualRgb)(n, Object(c.parseRgb)(String(e))),
        ...
        constructor() {
          super(...arguments),
            ...
            (this._handlePosition = (e) => {
              ...
              if (!o) return;
              const n = Object(l.ensureNotNull)(
                  this._container,
                ).getBoundingClientRect(),
                s = e.clientX - n.left,
                i = e.clientY - n.top;
        ...
        constructor() {
          super(...arguments),
            ...
            (this._handlePosition = (e) => {
              ...
              if (!n) return;
              const s = Object(l.ensureNotNull)(
                this._container,
              ).getBoundingClientRect();
