          ...
          if (null !== this._data) {
            ...
            if (
              ...
              var c = _ + 8 + (i - s) / 2,
                p = l(t, s);
              if (
                (t.fillText(this._data.dateString, c + p, m + e + 8),
        ...
        updateImpl() {
          ...
          if (
            ...
            if (null != s) {
              ...
              if (((this._point = new a(d, l)), this._gotoDateResult.eod))
                this._eod = !0;
              else {
                var o = this._series.model().timeScale().indexToUserTime(t);
                (this._dateString = new r().format(o)),
                  this._series.isDWM() ||
                    (this._timeString = new n().format(o));
              }
            }
          }
        }
