  ...
  ['object-tree-dialog'],
  {
    ...
    '+wZE': function (e, t, n) {
      ...
      function l(e) {
        ...
        return i.a.createElement(
          c.a,
          Object.assign({ className: s()(u.button, n && u.disabled, t) }, o),
        );
      }
    },
    '/XZa': function (e, t, n) {
          ...
          o.a.createElement(
            ...
            o.a.createElement(
              ...
              n &&
                o.a.createElement(
                  'div',
                  { className: s()(O.ellipsis, O.subtitle) },
                  n,
                ),
            ),
            u,
    ...
    'p0W+': function (e, t, n) {
      ...
      const c = o.forwardRef((e, t) => {
        ...
        return o.createElement(
          a.b,
          Object.assign({}, c, { ref: t, className: i(n, s.button) }),
        );
      });
    },
    px1m: function (e, t, n) {
    ...
    xNz2: function (e, t, n) {
      ...
      var k = n('p0W+'),
        ...
        L = n('JWMC');
      function B(e) {
        const { viewModel: t } = Object(D.ensureNotNull)(
        ...
        return o.a.createElement(
          ...
          o.a.createElement(
            'div',
            { className: T(A.title, A.withoutIcon) },
            Object(b.t)('Object tree'),
            !1,
          ),
          o.a.createElement(
            'div',
          ...
          function e(t, n, r) {
            ...
            !(function (e, t) {
              ...
              this.options.enableTouchEvents &&
                this.listenerTypes.push(H.touch),
              this.options.enableKeyboardEvents &&
                this.listenerTypes.push(H.keyboard);
          }
          var t, n, r;
          return (
            (t = e),
      ...
      function* gt(e) {
        const { selectedIds: t, nodes: n } = yield Object(w.b)(e),
          r = n.reduce(
            (e, t) => Object.assign(Object.assign({}, e), { [t.id]: t }),
            {},
          );
        yield Object(w.e)(((e) => ({ type: ce, nodes: e }))(r)),
          yield Object(w.e)(Le(t));
        !at(yield Object(w.f)()) &&
          t.length > 0 &&
          (yield Object(w.e)(Fe(t[0])), yield Object(w.e)(Ue(t[0])));
      }
      function* vt(e) {
        for (;;) {
      ...
      function* yt(e, t) {
        for (;;) {
          const { type: n } = yield Object(w.g)([ve, ge]),
            ...
            c = Dt(r, s, o, a),
            { id: u } = c;
          e ? e([u], s) : yield Object(w.e)(Le([u])),
            t && t(u),
            yield Object(w.e)(Fe(u));
        }
      }
      function* mt(e, t = () => !0) {
        for (;;) {
          ...
          if (1 === n) o ? i.push(r) : i.splice(i.indexOf(r), 1);
            ...
            -1 === n &&
              (n = a.reduce((e, t, n) => (i.includes(t.id) ? n : e), -1));
      ...
      function* Ot(e = () => !0, t) {
        ...
        l.map((e) => e.id).includes(d.id)
          ...
          : f &&
            e(l, d, r) &&
            (yield Object(w.e)(
              ((e, t, n) => ({ type: Oe, node: e, dropType: t, boundBox: n }))(
                d,
                r,
                i,
              ),
      ...
      function Dt(e, t, n, r) {
        ...
        for (
          ...
          (Math.abs(a) < o &&
            (s = i).level > 1 &&
            !nt(e, Object(D.ensureDefined)(s.parentId)));
      ...
      function* Tt(e = {}) {
        ...
        for (
          t && u.push(Object(w.d)(t)),
            o && u.push(Object(w.d)(wt, o)),
            c && u.push(Object(w.d)(vt, c));
          ;
          ...
          switch (t.type) {
              ...
              for (const e of n) {
                ...
                if (o.hasOwnProperty(t)) {
                  !Object(Ct.deepEquals)(o[t].children, e.children)[0] &&
                    (o[t] = Object.assign(Object.assign({}, o[t]), {
                      children: [...e.children],
                    }));
                } else {
                  o[t] = e;
            ...
            case le: {
              ...
              return Object.assign(Object.assign({}, e), {
                [r]: Object.assign(Object.assign({}, e[r]), o),
              });
            }
            case de: {
              const { nodes: n } = t,
            ...
            case Me: {
              ...
              for (const t of n) {
                ...
                s[t] = Object.assign(Object.assign({}, n), {
                  parentId: i,
                  level: a.level + 1,
                });
              }
              ...
              return (
                ...
                (s[i] = Object.assign(Object.assign({}, e[i]), {
                  children: c,
                  isExpanded: !0,
                })),
      ...
      class Ut extends o.a.PureComponent {
          ...
          super(...arguments),
            ...
            (this._handleRef = (e) => {
              ...
              Object(D.ensureDefined)(n)(this._ref),
                ...
                Object(D.ensureDefined)(r)(Object(z.getEmptyImage)(), {
        ...
        render() {
          return o.a.createElement(
            zt,
            Object.assign({}, this.props, { reference: this._handleRef }),
          );
        }
        getNode() {
      ...
      const zt = (e) => {
          ...
          return (
            xt.CheckMobile.any() &&
              ((S = n), (w = { onMouseOut: Ft, onMouseOver: Ft })),
            o.a.createElement(
              'div',
              Object.assign(
                {
      ...
      const dn = Object(ie.DragLayer)(function (e) {
          ...
          Object(U.b)(
            ...
            return $t(function () {
              ...
              const s = {
                  [un.dropTarget]: 'inside' !== t,
                  [un.dropTargetInside]: 'inside' === t,
                },
                { width: c, height: u } = n,
                [l, d] = a(e),
      ...
      const bn = o.a.forwardRef(function (e, t) {
          ...
          Object(r.useEffect)(() => {
            const e = (e) => {
                [Nt.Modifiers.Mod, Nt.Modifiers.Shift].includes(
                  Object(Nt.modifiersFromEvent)(e),
                ) && s();
              },
              t = (e) => {
                c &&
                  ...
                  const n = Object(D.ensureNotNull)(e.current),
                    r = (e) => {
                      if (e.target instanceof Element) {
                        const n = Object(D.ensureNotNull)(
          ...
          const x = Object(r.useCallback)(
              () => Object(D.ensureNotNull)(K.current),
              [],
            ),
          ...
          const L = Object(r.useCallback)((e) => {
            ...
            H = Object(r.useCallback)(
              (e) => Object(D.ensure)(A.current[e].node.key),
              [],
            ),
            G = Object(r.useMemo)(
              () =>
                null === b
                  ? { index: -1 }
                  : { index: A.current.findIndex((e) => e.node.key === b.id) },
              [b],
            );
          f(k);
          ...
          Object(r.useEffect)(
            () => Object(D.ensureNotNull)(W.current).resetAfterIndex(0, !0),
            [R],
          ),
            Object(r.useEffect)(
              () => Object(D.ensureNotNull)(W.current).scrollToItem(G.index),
              [G],
            );
          ...
          return (
            ...
            o.a.createElement(
              ...
              o.a.createElement(
                ...
                o.a.createElement(
                  rn.a,
                  Object.assign({}, F, { className: pn.overlayScrollWrap }),
                ),
        ...
        yn = Object(ie.DropTarget)(
          ...
          {
            drop: (e, t, n) => {
              ('touch' === e.drag || xt.isFF) && n.stopScroll(),
      ...
      function _n(e) {
        ...
        return (
          ...
          Object(r.useEffect)(
            () => (
              null !== b &&
                ...
                b.dispatch(((e) => ({ type: ue, nodes: e }))(u))),
              () => {}
            ),
            [b, u],
          ),
          ...
          null === b
            ...
            : o.a.createElement(
                Sn,
                Object.assign({ store: b, scrollToId: g }, v),
              )
        );
      }
        ...
        return (
          ...
          o.a.createElement(
            ...
            o.a.createElement(
              U.a,
              { store: t, context: Vt },
              o.a.createElement(mn, Object.assign({}, i)),
            ),
          )
        );
      });
      ...
      function* Cn() {
        for (;;) {
          ...
          1 === e && wn('Multi select', 'Ctrl'),
            2 === e && wn('Multi select', 'Shift');
        }
      }
      function* En(e) {
        for (;;) {
      ...
      function Ln(e) {
        const {
          ...
          h = Object(r.useMemo)(
            () => ({ isTouch: Modernizr.touch, isDialog: a }),
            [a],
          );
        return o.a.createElement(
          kn.Provider,
      ...
      function Xn(e) {
        ...
        return null === a
          ? null
          : o.a.createElement(Zn, Object.assign({}, e, { entity: a }));
      }
      function Zn(e) {
        const {
            id: t,
        ...
        Object(r.useEffect)(() => {
          ...
          return (
            ...
            l
              ...
              .subscribe(e, () => M(l.isActualInterval())),
            () => {
          ...
          Object(r.useEffect)(() => {
            g &&
              y.current &&
              (y.current.focus(), y.current.setSelectionRange(0, m.length));
          }, [g]),
          Object(r.useEffect)(() => {
            const e = {};
            return (
          ...
          Object(r.useEffect)(() => {
            !a && R.current && (clearTimeout(R.current), (R.current = null)),
              v(!1);
          }, [a]);
        ...
        const G = Gn.enabled('test_show_object_tree_debug')
            ? `<${l.id()}> (${l.zOrder()})`
            : l.title(),
          F = c || I,
          U = g && a,
        ...
        return o.a.createElement(
          'span',
          {
            ...
            onMouseDown: function (e) {
              g &&
                !Object(D.ensureNotNull)(y.current).contains(e.target) &&
                N(!0);
            },
            onClick:
              1 === p
          ...
          !U &&
            o.a.createElement(
              ...
              B &&
                ...
                o.a.createElement(
                  'span',
                  { className: T(Qn.icon, Qn.textIcon) },
                  B.content,
                ),
              o.a.createElement(
                'span',
                  ...
                  (F || !w || !E) &&
                    o.a.createElement(Un.a, {
                      ...
                      className: T(
                        Qn.button,
                        Qn.viewButton,
                        !E && [Qn.warn, 'apply-common-tooltip'],
                      ),
                      onClick: E
                        ? function (e) {
                            if (e.defaultPrevented) return;
                            e.preventDefault(),
                              A.setIsVisible(t, !l.isVisible());
                          }
                        : void 0,
                      title: E ? void 0 : K,
                      disabled: !E,
      ...
      class ar {
        ...
        set(e) {
          ...
          for (const r of e) {
            ...
            r.hasChildren()
              ? (t.push(...Array.from(o.values()).map(or)),
                (n = n.filter((e) => !o.has(e))))
              : t.push(r.id());
          }
      ...
      function Or(e) {
        return e instanceof ur.DataSource && e.showInObjectTree()
          ? e.id()
          : null;
      }
      const _r = new rr.a();
        ...
        getIcon() {
          ...
          if (e && t)
            if ('loadSvg' === t.type) {
              ...
              'text' === t.type && (r = { type: Hn.Text, content: t.text });
          return r;
        }
        setVisible(e) {
          const t = (e ? pr : gr).format({
      ...
      class wr {
        ...
        canBeAddedToSelection() {
          ...
          return this._group
            .lineTools()
            .every((t) => e.selection().canBeAddedToSelection(t));
        }
        setAsSelection() {
          this._undoModel.model().selectionMacro((e) => {
            e.clearSelection(),
        ...
        children() {
          ...
          return (
            ...
            e.map((e) => new Sr(this._undoModel, e))
          );
        }
        hasChildren() {
          return !0;
      ...
      class Dr {
        ...
        canBeGroupped(e) {
          ...
          if (
            ...
            t.some((e) => !Object(sr.isLineTool)(e)))
          )
            return !1;
          const n = this._undoModel.model(),
        ...
        buildTree() {
          ...
          for (const n of this._controller.model().panes()) {
            ...
            for (const o of this._groupModel.groups()) {
              const r = Object(D.ensureNotNull)(
                this._facade.getObjectById(o.id),
              );
              if (r.pane() === n) {
                t[r.id()] = r;
                const i = [...o.lineTools()]
                  ...
                  .map((e) => e.id());
                (e[r.id()] = jr(r.id(), 1, n.id(), i)),
                  e[n.id()].children.push(r.id());
                for (const n of i)
                  (t[n] = Object(D.ensureNotNull)(
                    this._facade.getObjectById(n),
                  )),
                    (e[n] = jr(n, 2, r.id()));
              }
            }
            for (const o of r)
              e[o.id()] ||
                ...
                (t[o.id()] = Object(D.ensureNotNull)(
                  this._facade.getObjectById(o.id()),
                )));
            e[n.id()].children.sort((e, n) =>
              Object(D.ensureNotNull)(t[e].zOrder()) >
      ...
      class Gr {
        constructor(e) {
          (this._entitiesCache = {}),
            ...
            (this._ensuredEntity = (e) =>
              Object(D.ensureNotNull)(this._getEntityById(e))),
            (this._chart = e),
            this._init();
        }
        destroy() {
        ...
        setIsLocked(e, t) {
          const n = this._getObjectsToModify(e),
            r =
              (t ? Object(b.t)('Lock') : Object(b.t)('Unlock')) +
              ' ' +
              Object(b.t)('objects');
        ...
        setIsVisible(e, t) {
          const n = this._getObjectsToModify(e),
            r =
              (t ? Object(b.t)('Show') : Object(b.t)('Hide')) +
              ' ' +
              Object(b.t)('objects');
          this._controller.withMacro(r, () => {
        ...
        remove(e) {
          const t = () => {
              this._controller.withMacro(Object(b.t)('Remove objects'), () => {
                for (const e of n)
                  e.remove(), delete this._entitiesCache[e.id()];
              }),
                wn('Delete', Dn(n)),
                this._update();
            },
        ...
        canNodeWithIdBeUnmerged(e) {
          const t = this._model.dataSourceForId(e);
          return (
            null !== t && Hr(t) && this._model.isUnmergeAvailableForSource(t)
          );
        }
        unmergeSelectionUp() {
        ...
        copySelection() {
          const e = this._getSelectedEntities(),
            t = e.map((e) =>
              Object(D.ensureNotNull)(this._model.dataSourceForId(e.id())),
            );
          this._chart
            .value()
        ...
        cloneSelection() {
          ...
          t.every(sr.isLineTool) &&
            (this._controller.cloneLineTools([...t], !1), wn('Clone', Dn(e)));
        }
        rename(e, t) {
        ...
        async openContextMenu(e, t, n) {
          ...
          if (this._objects.some((e) => e.hasChildren()))
            ...
            if (
              ((o = Array.from(e).filter(
                (e, t, n) =>
                  e.type !== Mr.a.Separator ||
                  !n[t + 1] ||
                  n[t + 1].type !== Mr.a.Separator,
              )),
          ...
          o.length > 0 &&
            Pn.ContextMenuManager.createMenu(
              o,
        ...
        getNextNodeIdAfterRemove(e) {
          ...
          if (
            ...
            return Object(D.ensureDefined)(n.find((e) => e.id === t))
              .children[0];
          }
          const i = Object(D.ensureDefined)(n.find((e) => e.id === r.parentId))
            .children;
          return 1 === i.length
        ...
        _normalizeTargetAndDropType(e, t) {
          ...
          return (
            'inside' === t &&
              ((t = 'before'),
              (n = Object(D.ensureDefined)([...n.children()].shift()))),
            [n, t]
          );
        }
