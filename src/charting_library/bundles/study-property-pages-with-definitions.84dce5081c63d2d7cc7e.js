        ...
        _inputsPropertyDefinitions() {
          ...
          return (
            null !== this._sourceInput &&
              (this._inputSourceItems = new u.a(this._getInputSourceItems())),
            (function (e, t, s, o, r) {
              const l = [];
              for (const c of t) {
                if (!p(c, o)) continue;
                ...
                if ('resolution' === c.type)
                  y = Object(n.k)(
                    { option: Object(n.b)(e, s[c.id], 'Change ' + t) },
                    {
                      id: 'StudyInput' + t,
                      title: a,
                      options: new u.a(r.resolutionItems),
                    },
                  );
                  ...
                  c.min && (i.min = new u.a(c.min)),
                    ...
                    void 0 !== c.step &&
                      isFinite(c.step) &&
                      c.step > 0 &&
                      (i.step = new u.a(c.step)),
                    (y = Object(n.j)(
                      { value: Object(n.b)(e, s[c.id], 'Change ' + a) },
                      i,
                    ));
                } else
                  y = Object(n.q)(
        ...
        _getInputSourceItems() {
          ...
          if (
            ...
            (this._source.isChildStudy() ||
              h.a.canBeChild(this._source.metaInfo()))
          ) {
              ...
              .forEach((t) => {
                ...
                if (1 === l.length) e.push({ id: o, value: o, title: s });
                  ...
                  const t = l.reduce((e, t, n) => {
                    ...
                    let l;
                    try {
                      l = Object(i.ensureDefined)(
                        Object(i.ensureDefined)(r)[t.id],
                      ).title;
                    } catch (u) {
                      l = t.id;
                    }
