    ...
    MfqI: function (e, t, n) {
        ...
        return (
          ((t = class extends i.PureComponent {
            constructor(e, t) {
              ...
              const n = (this._binding = Object(f.ensureDefined)(
                R.get(t.chartWidget),
              ));
              this.state = n.state();
            }
      ...
      class me extends i.PureComponent {
        ...
        updateTimezonesButton() {
          ...
          if ('exchange' === t) {
            const n = Object(f.ensureNotNull)(
      ...
      function pe(e) {
        return i.createElement('span', {
          className: c(ge.separator, e.className),
        });
      }
      var be = n('tU7i'),
        ve = n('qFKp');
              ...
              null === this._raf &&
                (this._raf = requestAnimationFrame(() => {
                  ...
                  if (
                    ...
                    const t =
                      o -
                      Object(f.ensureNotNull)(this._rangeCollapsed)
                        .offsetWidth -
                      0;
                    let n = 0,
                      s = 0;
            ...
            i.createElement(
              ...
              this.props.timeWidgetEnabled &&
                i.createElement(
                  ...
                  i.createElement(
                    'div',
                    {
                      className: c(Re.inline, e.timeZones && Re.collapsed),
              ...
              i.createElement(
                ...
                this.props.logScaleButtonEnabled &&
                  i.createElement(Oe, { className: Re.item }),
                this.props.autoScaleButtonEnabled &&
                  i.createElement(Ae, { className: Re.item }),
      ...
      function g(e) {
        ...
        return a.a.createElement(
          ...
          Object.assign({}, W, {
            ...
            role: n,
            'aria-selected': i,
            className: o(d, A.item, _ && A.withIcon, {
              [A.isActive]: C,
              [A.isDisabled]: S || y,
              [A.hovered]: E,
            }),
          ...
          void 0 !== k &&
            a.a.createElement(
              'div',
              { onClick: m, className: o(A.toolbox, { [A.showOnHover]: N }) },
              k,
            ),
        );
        var B;
    ...
    l4ku: function (e, t, n) {
      ...
      function g(e) {
        ...
        return n
          ? s.a.createElement(
              'li',
              { className: a(m.item, m.loading) },
              s.a.createElement(r.a, { color: 'gray' }),
            )
          : s.a.createElement(
              'li',
              {
              ...
              s.a.createElement(
                'span',
                { className: a(m.label, R && m.fullWidth) },
                y,
              ),
              !!N &&
                s.a.createElement(o.a, {
              ...
              !O &&
                S &&
                s.a.createElement(c.a, { className: m.shortcut, text: S }),
