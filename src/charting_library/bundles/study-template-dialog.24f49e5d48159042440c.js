(window.webpackJsonp = window.webpackJsonp || []).push([
  ['study-template-dialog'],
  {
    ...
    '8Rai': function (e, t, n) {
      ...
      const i = function (
        e,
        { bubbles: t = !1, cancelable: n = !1, detail: s = null } = {},
      ) {
        try {
      ...
      class c extends s.PureComponent {
        ...
        render() {
          ...
          return (
            ...
            i.createPortal(
              s.createElement(l.Provider, { value: this }, this.props.children),
              e,
            )
          );
        }
        ...
        _manager() {
          return null === this.context
            ? Object(r.getRootOverlapManager)()
            : this.context;
        }
      }
      c.contextType = a.b;
    ...
    IDfV: function (e, t, n) {
        ...
        constructor(e) {
          if (
            ...
            (this._handleChange = (e) => {
              ...
              if (t && '' === r)
                this.setState({ queryValue: r, isOpened: !1, active: void 0 }),
                  o && o();
              else {
                ...
                this.setState({
                  queryValue: r,
                  isOpened: t,
                  active: n ? void 0 : this._getActiveKeyByValue(r),
                }),
                  t && i && i();
              }
              n && s && s(r);
            ...
            (this._handleKeyDown = (e) => {
              ...
              switch (e.which) {
                ...
                case s.Enter:
                  let m = r;
                  t &&
                    (a && m ? this.setState(this._valueToQuery(m)) : (m = c)),
                    void 0 !== m &&
                      (this._close(),
                      a || this._blur(),
                      m !== n
        ...
        _renderSuggestions() {
          const e = this._suggestions(this.state.queryValue),
            t = Object.keys(e).map((t) => {
              const n = l(g.suggestion, {
                [g.selected]: this.state.active === t,
              });
              return r.createElement(
                'li',
      ...
      class C extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(_.a, {
            ...
            submitButtonText: r.createElement(O, {
        ...
        return (
          ...
          a.a.createElement(
            ...
            a.a.createElement(
                ...
                a.a.createElement(u.a, {
                  label: a.a.createElement(
                    ...
                    a.a.createElement(f.a, {
                      icon: E,
                      className: l(x.hintMark, 'apply-common-tooltip'),
                      title: n,
                    }),
                  ),
                  onChange: function () {
              ...
              a.a.createElement(
                'div',
                { className: l(x.indicators, S && x.withSuggestions) },
                o,
              ),
            ),
          )
      ...
      function H(e, t, n) {
        const s = () => {
          U.backend.invalidateStudyTemplatesList(),
            U.backend.getStudyTemplatesList().then(t);
        };
      ...
      class Q {
        ...
        _prepareData(e, t, n) {
          ...
          return {
            ...
            meta_info: Object(q.a)(this._controller, s.interval),
          };
        }
        _doSave(e, t, n) {
        ...
        _getActualTemplateList() {
          return (
            U.backend.invalidateStudyTemplatesList(),
            U.backend.getStudyTemplatesList()
          );
        }
        _showTemplateSaveRenameDialog(e, t, n) {
          ...
          (this._dialog = new D({
            ...
            saveIntervalHintText: P.format({
              interval: Object(R.translatedIntervalString)(n),
            }),
    ...
    'ML8+': function (e, t, n) {
      ...
      function c(e) {
        ...
        return s.createElement(o.a, {
          className: i(n, r.icon, { [r.dropped]: t }),
          icon: a,
        });
      }
    },
        ...
        render() {
          ...
          return (
            this.props.label &&
              (h = i.createElement(
                'span',
                { className: u, title: this.props.title },
                this.props.label,
              )),
            i.createElement(
              'label',
              { className: l },
              i.createElement(a.a, Object.assign({}, r, { className: t })),
              h,
            )
          );
        }
      ...
      function c(e) {
        ...
        return s.createElement(
          ...
          s.createElement(
            'span',
            { className: t },
            s.createElement(o.a, { icon: r, className: a.icon }),
          ),
        );
      }
    },
