  ...
  ['currency-label-menu'],
  {
    ...
    '9agd': function (e, t, n) {
      ...
      function w(e) {
        ...
        return i.a.createElement(
          ...
          void 0 !== r &&
            i.a.createElement(
              'div',
              { className: C()(S.description, u && S.small) },
              m(r),
            ),
        );
        function m(e) {
      ...
      function k(e) {
        ...
        function C(e) {
          ...
          return i.a.createElement(
            w,
            Object.assign(
              { key: t, rules: p, search: s, onClose: a, isSmallSize: !0 },
              n,
            ),
          );
        }
                ...
                r
                  ? E(a, r, l).map((e) => {
                      ...
                      return i.a.createElement(
                        w,
                        Object.assign(
                          { key: t, isActive: n, rules: l, search: r },
                          o,
                        ),
                      );
                    })
      ...
      function Y(e, t, n) {
        ...
        return (
          r.a.render(i.a.createElement(B, Object.assign({}, c)), o),
    ...
    Iksw: function (e, t, n) {
      ...
      function l(e, t) {
        return (n, l) => {
          ...
          return {
            x: b - (h === r.FromRightToLeft ? n : 0) + p,
            y: E - (m === a.FromBottomToTop ? l : 0) + v,
          };
        };
      }
    },
    ...
    aWqZ: function (e, t, n) {
      ...
      function a(e, t, n) {
        ...
        for (const o of h)
          m.actions.push(
            r(o.id, o.code, t.selectedCurrency === o.id, () => c(o.id)),
          );
      ...
      function a(e, t, n) {
        ...
        for (const o of h)
          for (const e of o.units)
            e.id !== s &&
              l.has(e.id) &&
              m.actions.push(r(e.id, e.name, e.description, !1, () => c(e.id)));
        m.actions.length > 0 && a.push(m);
          ...
          for (const o of h) {
            ...
            for (const t of o.units)
              t.id === s ||
                l.has(t.id) ||
                e.actions.push(
                  r(t.id, t.name, t.description, !1, () => c(t.id)),
                );
        ...
        for (const o of h) {
          ...
          for (const t of o.units)
            t.id === s ||
              l.has(t.id) ||
              e.actions.push(r(t.id, t.name, t.description, !1, () => c(t.id)));
          e.actions.length > 0 && a.push(e);
        }
        return a;
      }
