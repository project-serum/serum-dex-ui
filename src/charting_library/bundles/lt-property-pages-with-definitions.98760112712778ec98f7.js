  ...
  ['lt-property-pages-with-definitions'],
  {
    ...
    '17v9': function (e, t, i) {
      ...
      const h = window.t('Trend Line'),
        ...
        _ = window.t('Extend Lines Left'),
        j = window.t('Reverse'),
        C = window.t('Prices'),
        O = window.t('Levels'),
        f = window.t('Labels'),
        y = window.t('Use one color'),
        L = window.t('Background'),
        v = window.t('Fib levels based on log scale'),
        M = [
        ...
        _stylePropertyDefinitions() {
          ...
          'extendLines' in t &&
            ...
            'extendLinesLeft' in t &&
              ((x.extendLeft = t.extendLinesLeft), ($.extendLeftTitle = _)),
            'extendRight' in t &&
          ...
          const T = Object(s.m)(S, l + 'LeveledLinesGroup');
          e.push(Object(s.l)([T], l + 'Group'));
          const V = Object(s.e)(
            {
              color: Object(s.v)(
                this._undoModel,
      ...
      class j extends s.a {
        _stylePropertyDefinitions() {
          const e = [],
            ...
            s = Object(l.c)(i),
            j = [],
            C = this._source.hLevelsCount();
          for (let o = 1; o <= C; o++) {
            const e = t['hlevel' + o].childs(),
              l = Object(n.h)(
                {
                  checked: Object(n.b)(
                    this._undoModel,
          ...
          const O = Object(n.m)(j, s + 'HLeveledLinesGroup'),
            f = Object(n.c)(
              {
                checked: Object(n.b)(
                  this._undoModel,
            ...
            L = Object(n.l)([O, f, y], s + 'HLevelGroup', a);
          e.push(L);
          const v = [],
            M = this._source.vLevelsCount();
          for (let o = 1; o <= M; o++) {
            const e = t['vlevel' + o].childs(),
              l = Object(n.h)(
                {
                  checked: Object(n.b)(
                    this._undoModel,
          ...
          const k = Object(n.m)(v, s + 'VLeveledLinesGroup'),
            x = Object(n.c)(
              {
                checked: Object(n.b)(
                  this._undoModel,
      ...
      class j extends s.a {
        _stylePropertyDefinitions() {
          ...
          const O = Object(n.m)(j, s + 'HLeveledLinesGroup'),
            ...
            v = Object(n.l)([O, f, y, L], s + 'HLevelGroup', a);
          e.push(v);
          const M = [],
          ...
          const x = Object(n.m)(M, s + 'VLeveledLinesGroup'),
            ...
            P = Object(n.l)([x, $, m, S], s + 'VLevelGroup', u);
          e.push(P);
          const T = Object(n.e)(
            {
              color: Object(n.v)(
    ...
    '78yF': function (e, t, i) {
      ...
      function j(e, t, i, s) {
        ...
        const L = Object(n.c)(
          ...
          { id: r + 'BarsRange', title: (s && s.barRange) || b },
        );
        ...
        const v = Object(n.c)(
          ...
          { id: r + 'ShowStats', title: (s && s.showStats) || _ },
        );
        j.push(v);
        const M = Object(n.k)(
          {
    ...
    Ax76: function (e, t, i) {
      ...
      class _ extends s.a {
        _stylePropertyDefinitions() {
          ...
          if ((e.push(_), t.hasOwnProperty('borderWidth'))) {
            const n = Object(o.a)(
              this._undoModel,
              {
    ...
    CA9d: function (e, t, i) {
      ...
      var o = i('HSjo'),
        ...
        s = i.n(n),
        l = i('25b6');
      const r = window.t('Price'),
        c = window.t('Bar#');
      function d(e, t, i) {
        return {
          property: Object(o.b)(e, t.price, `Change ${r} Y coordinate`),
          info: { typeY: 1, stepY: i },
        };
      }
      function a(e, t) {
        return {
          property: Object(o.b)(e, t.bar, `Change ${c} X coordinate`),
          info: {
            typeX: 0,
            minX: new s.a(-5e4),
            maxX: new s.a(15e3),
      ...
      function u(e, t, i, n, s, r) {
        const c = a(e, t),
          u = d(e, t, n);
        return Object(o.f)(
          { x: c.property, y: u.property },
          Object.assign(
            Object.assign(
              { id: Object(l.c)(`${r}Coordinates${s}`), title: s },
              c.info,
            ),
            u.info,
          ),
    ...
    Cn8r: function (e, t, i) {
      ...
      const L = window.t('Visibility'),
        v = window.t('Coordinates'),
        M = window.t('Style'),
        k = window.t('Text'),
        x = window.t('Inputs');
      class $ {
              ...
              const y = Object(n.n)(
                  {
                    ...
                    from: Object(n.b)(
                      e,
                      t.weeksFrom,
                      'Change Line Tool Weeks From',
                    ),
                    to: Object(n.b)(e, t.weeksTo, 'Change Line Tool Weeks To'),
                  },
                  {
                ...
                L = Object(n.n)(
                  {
                    ...
                    from: Object(n.b)(
                      e,
                      t.monthsFrom,
                      'Change Line Tool Months From',
                    ),
                    to: Object(n.b)(
                      e,
                      t.monthsTo,
                      'Change Line Tool Months To',
                    ),
                  },
                  {
        ...
        _createCoordinatesPropertyPage() {
          ...
          return null !== e ? Object(s.a)(e, 'coordinates', v) : null;
        }
        _getYCoordinateStepWV() {
          return (
            null === this._yCoordinateStepWV &&
              ((this._yCoordinateStepWV = new r.a(
                (function (e) {
                  if (null !== e) {
                    const t = e.priceStep();
                    if (null !== t) return t;
        ...
        _createStylePropertyPage() {
          ...
          return null !== e ? Object(s.a)(e, 'style', M) : null;
        }
        _stylePropertyDefinitions() {
          return null;
        }
        _createTextPropertyPage() {
          ...
          return null !== e ? Object(s.a)(e, 'text', k) : null;
        }
        _textPropertyDefinitions() {
          return null;
        }
        _createInputsPropertyPage() {
          ...
          return null !== e ? Object(s.a)(e, 'inputs', x) : null;
        }
    ...
    'D+Nk': function (e, t, i) {
      ...
      class b extends s.a {
        _stylePropertyDefinitions() {
          ...
          const g = this._source.levelsCount();
          for (let o = 0; o <= g; o++) {
            const t = i['level' + o].childs(),
              n = Object(l.h)(
                {
                  checked: Object(l.b)(
                    this._undoModel,
                    t.visible,
                    `Change ${s} Level ${o + 1} Line Visibility`,
                  ),
                  color: Object(l.v)(
                    this._undoModel,
                    t.color,
                    null,
                    `Change ${s} Level ${o + 1} Line Color`,
                  ),
                  width: Object(l.b)(
                    this._undoModel,
                    t.linewidth,
                    `Change ${s} Level ${o + 1} Line Width`,
                  ),
                  style: Object(l.b)(
                    this._undoModel,
                    t.linestyle,
                    `Change ${s} Level ${o + 1} Line Style`,
                  ),
                  level: Object(l.b)(
                    this._undoModel,
                    t.coeff,
                    `Change ${s} Level ${o + 1} Line Coeff`,
                  ),
                },
                { id: `${b}LineLevel${o + 1}` },
              );
    ...
    RYNR: function (e, t, i) {
      ...
      const a = window.t('Lines'),
        ...
        f = window.t('Lot size'),
        y = window.t('Risk'),
        L = window.t('Always show stats'),
        v = window.t('Show price labels'),
        M = window.t('%'),
        k = window.t('Cash');
      function x(e) {
        return [
        ...
        _inputsPropertyDefinitions() {
          const e = this._source.properties().childs(),
            ...
            a = Object(l.j)(
              ...
              { id: i + 'EntryPrice', title: _, type: 1, step: o },
            ),
            ...
            w = Object(l.l)([h, b], i + 'ProfitLevel', j),
            L = Object(l.j)(
              {
                value: Object(l.b)(
                  this._undoModel,
          ...
          return [u, w, Object(l.l)([L, v], i + 'StopLevel', C)];
        }
    ...
    WfUZ: function (e, t, i) {
      ...
      class y extends s.a {
        _stylePropertyDefinitions() {
          ...
          for (let o = 0; o < r; o++) {
            const e = t.levels.childs()[o].childs(),
              r = Object(n.h)(
                {
                  checked: Object(n.b)(
                    this._undoModel,
                ...
                { id: `${s}LineLevel${o}`, title: '' + o },
              );
            l.push(r);
          }
          const y = Object(n.m)(l, s + 'LeveledLinesGroup');
          e.push(Object(n.l)([y], s + 'LevelGroup', j));
          const L = [],
            v = t.fanlines.childCount();
          for (let o = 0; o < v; o++) {
            const e = t.fanlines.childs()[o].childs(),
              l = Object(n.h)(
                {
                  checked: Object(n.b)(
                    this._undoModel,
                    e.visible,
                    `Change ${i} Fan ${o} Line Visibility`,
                  ),
                  color: Object(n.v)(
                    this._undoModel,
                    e.color,
                    null,
                    `Change ${i} Fan ${o} Line Color`,
                  ),
                  width: Object(n.b)(
                    this._undoModel,
                    e.width,
                    `Change ${i} Fan ${o} Line Width`,
                  ),
                },
                {
                  id: `${s}FanLineLevel${o}`,
                  title: `${e.x.value()}x${e.y.value()}`,
                },
              );
            L.push(l);
          }
          const M = Object(n.m)(L, s + 'FanLeveledLinesGroup');
          e.push(Object(n.l)([M], s + 'FanLinesGroup', C));
          const k = [],
            x = t.arcs.childCount();
          for (let o = 0; o < x; o++) {
            const e = t.arcs.childs()[o].childs(),
              l = Object(n.h)(
                {
                  checked: Object(n.b)(
                    this._undoModel,
                    e.visible,
                    `Change ${i} Arcs ${o} Line Visibility`,
                  ),
                  color: Object(n.v)(
                    this._undoModel,
                    e.color,
                    null,
                    `Change ${i} Arcs ${o} Line Color`,
                  ),
                  width: Object(n.b)(
                    this._undoModel,
                    e.width,
                    `Change ${i} Arcs ${o} Line Width`,
                  ),
                },
                {
                  id: `${s}ArcsLineLevel${o}`,
                  title: `${e.x.value()}x${e.y.value()}`,
                },
              );
            k.push(l);
        ...
        _coordinatesPropertyDefinitions() {
          ...
          return [
            Object(r.f)(
              ...
              Object.assign(
                Object.assign(
                  { id: Object(n.c)(`${t}Coordinates${u}`), title: u },
                  i.info,
                ),
                o.info,
              ),
