  ...
  ['restricted-toolset', 'series-icons-map'],
  {
      ...
      class h extends n.PureComponent {
        render() {
          ...
          return n.createElement(
            ...
            n.createElement(
              'input',
              Object.assign({}, o, { type: 'checkbox', className: h, ref: t }),
            ),
            n.createElement(
              'div',
    ...
    miV2: function (e, t, a) {
      ...
      class g extends s.PureComponent {
        render() {
          ...
          return s.createElement(
            'div',
            Object.assign({ className: v(a, b.wrap) }, n),
            t,
          );
        }
      }
                ...
                u.a,
                {
                  ...
                  content: p
                    ...
                    : s.createElement(
                        g,
                        null,
                        s.createElement(h.a, { icon: r.SERIES_ICONS[n] }),
                      ),
      ...
      function F(e) {
        ...
        return s.createElement(
          ...
          Object.assign({}, o, {
            text: l ? t : void 0,
            className: v(a, R.button, l ? R.withText : R.withoutText),
          }),
        );
      }
      var z = a('JWMC'),
      ...
      function J(e, t) {
        ...
        return (
          ...
          Promise.all(a).then(
            (e) => (
              Q.logNormal('Requesting favorites info finished'),
      ...
      function ne(e) {
        return s.createElement(
          'div',
          { className: v(e.className, ae.title) },
          e.children,
        );
      }
      var se = a('XWsk'),
        ...
        constructor(e, t) {
          super(e, t),
            ...
            (this._handleSelectIndicator = (e) => {
              ...
              const { chartWidgetCollection: t } = this.context;
              if ('java' === e.type) {
                const t = Object(Y.tryFindStudyLineToolNameByStudyId)(
                  e.studyId,
                );
                ...
                (e) =>
                  i.a.createElement(
                    ...
                    i.a.createElement(
                      ...
                      i.a.createElement(
                        ne,
                        { className: e && ie.smallWidthTitle },
        ...
        constructor(e) {
          super(e),
            ...
            (this._getMenuPosition = () => {
              const e = Object(G.ensureNotNull)(
                this._timeMenu,
      ...
      const xe = {
        [me.ResolutionKind.Ticks]: window.t('Ticks', {
          context: 'interval_group_name',
        }),
        [me.ResolutionKind.Seconds]: window.t('Seconds', {
          context: 'interval_group_name',
        }),
        [me.ResolutionKind.Minutes]: window.t('Minutes', {
          context: 'interval_group_name',
        }),
        [me.SpecialResolutionKind.Hours]: window.t('Hours', {
          context: 'interval_group_name',
        }),
        [me.ResolutionKind.Days]: window.t('Days', {
          context: 'interval_group_name',
        }),
        [me.ResolutionKind.Weeks]: window.t('Weeks', {
          context: 'interval_group_name',
        }),
        [me.ResolutionKind.Months]: window.t('Months', {
          context: 'interval_group_name',
        }),
        [me.ResolutionKind.Range]: window.t('Ranges', {
          context: 'interval_group_name',
        }),
      ...
      class We extends i.a.PureComponent {
        constructor(e, t) {
          ...
          (this._defaultIntervals = a
            .defaultResolutions()
            .filter(Le)
            .map(ue.normalizeIntervalString)),
            (this.state = {
              isOpenedFormMenu: !1,
              activeInterval: h,
              favorites: d,
        ...
        componentWillUnmount() {
          ...
          e.getOnChange().unsubscribe(this, this._handleChangeFavorites),
            ...
            de.linking.supportedResolutions.unsubscribe(
              this._bindedForceUpdate,
            ),
        ...
        render() {
          ...
          (void 0 !== a ? d.concat(a) : d)
            .filter(ue.isAvailable)
            .forEach((e) => (h[e] = !0));
          const m =
            void 0 !== a ? Object(ue.getTranslatedResolutionModel)(a) : null;
          return i.a.createElement(
            g,
            { id: t },
            c &&
        ...
        _createIntervalForm(e) {
          if (this._customIntervals) {
            ...
            return [
              i.a.createElement(w.a, { key: 'custom-interval-separator' }),
              t,
            ];
          }
          return [];
        ...
        _renderMenuItems(e) {
          ...
          return (
            ...
            void 0 !== n &&
              (e ||
                f.push(
                  s.createElement(w.a, { key: 'existing-chart-section-begin' }),
                ),
              f.push(
                s.createElement(d.b, {
                  key: 'rename',
      ...
      class Ft extends i.a.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._onSymbolChanged = () => {
              this.setState({
                symbol: de.linking.symbol.value(),
                shortName: zt(),
              });
            }),
            (this.state = {
        ...
        componentDidMount() {
          de.linking.seriesShortSymbol.subscribe(this._onSymbolChanged),
            Object(Tt.a)();
        }
        componentWillUnmount() {
          de.linking.seriesShortSymbol.unsubscribe(this._onSymbolChanged),
            (this._promise = null);
        }
        render() {
          ...
          return i.a.createElement(S.b, {
            ...
            className: v(
              t,
              n.enabled('uppercase_instrument_names') && Rt.uppercase,
            ),
            theme: jt,
      ...
      function zt() {
        return (
          de.linking.seriesShortSymbol.value() ||
          de.linking.symbol.value() ||
          ''
        );
      }
      var Ht = a('9NBK');
      class Lt extends s.PureComponent {
        ...
        render() {
          ...
          return s.createElement(
            'div',
            {
              className: v(e, Ht.item, 'apply-common-tooltip'),
              onClick: this._handleClick,
              title: t.name,
            },
            s.createElement(
      ...
      function Pt(e) {
        return s.createElement(
          'div',
          { className: v(Dt.description, e.className) },
          e.children,
        );
      }
      var Vt = a('fESK');
      const Ut = Object(st.a)(d.a, {
          labelRow: Vt.labelRow,
          toolbox: Vt.toolbox,
          item: Vt.titleItem,
        }),
        Kt = Object(st.a)(d.a, {
      ...
      class ra {
        ...
        _setState(e) {
          this._state.setValue(
            Object.assign(Object.assign({}, this._state.value()), e),
          );
        }
        ...
        constructor(e, t) {
          ...
          (this._model = new ra(n, a)),
            (this.state = Object.assign(
              Object.assign({}, this._model.state().value()),
              { isActive: !1 },
            ));
        }
        componentDidMount() {
    ...
    'p0W+': function (e, t, a) {
      ...
      const r = s.forwardRef((e, t) => {
        ...
        return s.createElement(
          o.b,
          Object.assign({}, r, { ref: t, className: i(a, l.button) }),
        );
      });
    },
    pqsj: function (e, t) {
