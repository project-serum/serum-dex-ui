(window.webpackJsonp = window.webpackJsonp || []).push([
  ['symbol-search-dialog'],
  {
    ...
    '+wZE': function (e, t, n) {
      ...
      function u(e) {
        ...
        return a.a.createElement(
          i.a,
          Object.assign({ className: s()(l.button, n && l.disabled, t) }, o),
        );
      }
    },
    '/KDZ': function (e, t, n) {
    ...
    '8Rai': function (e, t, n) {
      ...
      const o = function (
        e,
        { bubbles: t = !1, cancelable: n = !1, detail: r = null } = {},
      ) {
        try {
    ...
    GcSm: function (e, t, n) {
            ...
            s.a.createElement(
              ...
              !!l &&
                s.a.createElement(F.a, {
                  className: h()(U.icon, U.allExchangesIcon),
                  icon: K,
                }),
            ),
            s.a.createElement(
      ...
      function se(e) {
        const { exchanges: t } = e,
          ...
          u =
            Object(J.a)({ watchedValue: ee.watchedTheme }) === te.a.Dark
              ? re
              : oe,
          ...
          b = Object(c.useCallback)(
            (e) =>
              ...
              e.desc.toLowerCase().includes(d.toLowerCase()),
            [d],
          ),
        ...
        const x = i
          ...
          : s.a.createElement(
              ...
              s.a.createElement(
                'div',
                { className: ae.emptyText },
                Object(f.t)('No exchanges match your criteria'),
              ),
            );
        return s.a.createElement(
          ne.Provider,
                ...
                g.map((e) => {
                  ...
                  return s.a.createElement(
                    ...
                    s.a.createElement(
                      ...
                      {
                        className: h()(
                          ae.exchangeItemsContainer,
                          !a && ae.exchangeItemsContainerDesktop,
                        ),
                      },
                      e.filter(b).map((e) => {
                        const t = O(e);
          ...
          ? s.a.createElement(
              'div',
              {
                ...
                onClick: function () {
                  r.current &&
                    (o.current = i
                      ? r.current.value.toUpperCase()
                      : r.current.value);
                  n('exchange');
                },
              },
              d
                ? s.a.createElement(F.a, { className: ie.icon, icon: K })
                : s.a.createElement('span', null, l.value),
            )
          : null;
      }
          ...
          d &&
            s.a.createElement(
              'label',
              {
                ...
                title: Object(f.t)(
                  'Show the markets you can place an order with {brokerName}',
                ).replace('{brokerName}', d),
              },
      ...
      function Ae(e) {
        const {
          ...
          { mode: u, isSmallWidth: d, handleListWidth: p } = Object(
            m.ensureNotNull,
          )(Object(c.useContext)(Z)),
      ...
      function Fe(e) {
        const {
          ...
          { isSmallWidth: _, isMobile: M } = Object(m.ensureNotNull)(
            Object(c.useContext)(Z),
          ),
          D = Boolean(x),
          L = !v && !y && (M || !D),
          A =
            Object(J.a)({ watchedValue: ee.watchedTheme }) === Pe.a.Dark
              ? ze.dark
              : ze.light,
          W = x;
        return s.a.createElement(
          ...
          s.a.createElement(
            ...
            {
              ref: C,
              className: h()(ze.itemInfoCell, ze.cell, b && ze.offset),
            },
            s.a.createElement(
              'div',
              {
              ...
              E &&
                s.a.createElement(F.a, {
                  className: h()(ze.expandHandle, w && ze.expanded),
                  icon: Ve,
                }),
            ),
            s.a.createElement(
              ...
              n &&
                s.a.createElement(
                  ...
                  'string' == typeof n && a
                    ...
                    : n,
                  p &&
                    s.a.createElement('span', { className: ze.dataMode }, 'E'),
                ),
              !n &&
                t &&
                s.a.createElement(
          ...
          !_ && B(),
          W
            ? s.a.createElement(W, Object.assign({}, e, { className: ze.cell }))
            : null,
          L &&
            s.a.createElement(
              'div',
              ...
              s.a.createElement(
                ...
                s.a.createElement(
                  'div',
                  { className: h()(ze.marketType, f && ze.active) },
                  l,
                ),
                s.a.createElement(
                  'div',
                  { className: h()(ze.exchangeName, f && ze.active) },
                  i,
                ),
              ),
              !1,
          ...
          s.a.createElement(
            'div',
            { className: h()(ze.cell, Boolean(R) && ze.actionsCell) },
            R,
          ),
        );
        function B() {
      ...
      function Ye(e) {
        ...
        const { state: n, update: r } = e,
          { searchRef: o, forceUpdate: a, upperCaseEnabled: i } = Object(
            m.ensureNotNull,
          )(Object(c.useContext)(Z)),
      ...
      function et(e) {
        ...
        const be = null != I ? I : Fe,
          ve = Object(c.useMemo)(
            () =>
              C.map((e) =>
                s.a.createElement(be, Object.assign({}, e, { searchToken: U })),
              ),
            [C],
          ),
          ...
          Ie = T
            ...
            : s.a.createElement(
                ...
                s.a.createElement(
                  ...
                  Object(f.t)('No symbols match your criteria'),
                ),
              );
        return s.a.createElement(
          ne.Provider,
          ...
          s.a.createElement(
            ...
            {
              reference: m,
              className: h()($e.search, R && $e.upperCase),
              placeholder: k || Object(f.t)('Search'),
            },
                ...
                'symbolSearch' === t &&
                  s.a.createElement(
                    ...
                    'loading' === Q &&
                      s.a.createElement(
                        'div',
                        { className: $e.spinnerWrap },
                        s.a.createElement(Oe.a, null),
                      ),
                    !1,
                    'empty' === Q && Ie,
                  ),
          ...
          v.enabled('show_spread_operators')
            ...
            : m.current &&
              ((se.current = {
                ...
                searchTokenValue: m.current.value,
              }),
              ie.current || (ie.current = setTimeout(Me, 0)));
        }
        function Me() {
        ...
        function De(e, t, n) {
          ...
          const r = (V.current = (function (e, t, n) {
            ...
            const c = v.enabled('show_spread_operators')
                ...
                ? void 0
                : r.value,
              s = v.enabled('show_spread_operators')
                ? L(e) || n
                : null == a
                ? void 0
                : a.value,
              i = {
                ...
                unhideSymbolSearchGroups: fe,
                signal:
                  null === (o = null == P ? void 0 : P.current) || void 0 === o
                    ? void 0
                    : o.signal,
              },
        ...
        function Ve() {
          'watchlist' === A.current &&
            (n('symbolSearch'),
            Object(We.trackEvent)('Watchlist', 'Mobile SS', 'Go to SS page'));
        }
        function ze(e) {
      ...
      var nt = n('U0JK'),
        rt = n('hYF9');
      function ot() {
        const { setMode: e, isMobile: t } = Object(m.ensureNotNull)(
          Object(c.useContext)(Z),
        );
      ...
      function dt(e) {
        ...
        Object(c.useLayoutEffect)(() => {
          ...
          (null == K ? void 0 : K.current) &&
            ...
            ('compare' !== R && (K.current.value = M.current),
            j && K.current.focus());
        }, [R]),
          Object(c.useEffect)(() => {
              ...
              F.reduce((e, t) => {
                ...
                return (
                  ...
                  r &&
                    ...
                    e.push(
                      ...t.contracts.map((e) =>
                        Object.assign(Object.assign({}, e), { parent: t }),
                      ),
                    ),
                  e
                );
                        ...
                        Object.assign(
                          {
                            className: h()(
                              st.dialog,
                              !e && (n ? st.tabletDialog : st.desktopDialog),
                            ),
                            fullScreen: p,
                            onKeyDown: Ee,
                            onClickOutside: t,
        ...
        function ve(e, n) {
          ...
          if (v.enabled('show_spread_operators')) {
            ...
            if (K.current && K.current.value.includes(','))
              return void ye(e, o, t);
          }
          const a = [
            {
              resolved: !0,
              symbol: at.fromSymbolSearchResult(e, n),
              result: r,
            },
          ];
          i(a), t();
        ...
        function ye(e, t, n) {
          ...
          (K.current.value = r),
            K.current.setSelectionRange(o, o),
            K.current.focus();
        }
        function Ee(e) {
          switch (Object(Be.hashFromEvent)(e)) {
        ...
        function we(e) {
          ...
          if (v.enabled('show_spread_operators') && X && n) {
            ...
            if (!Oe(n)) return;
            return (
              i([{ symbol: ut ? n.toUpperCase() : n, resolved: !1 }]),
              void (e && t())
            );
          }
                            ...
                            return new Promise((t) => {
                              ke({
                                ...
                                if (n.length) {
                                  ...
                                  if (a && c)
                                    return void t({
                                      symbol: at.fromSymbolSearchResult(e, o),
                                      resolved: !0,
                                      result: e,
                                    });
                                }
      ...
      function Nt(e) {
        const {
          ...
          { selectedAction: i } = Object(m.ensureNotNull)(
      ...
      function Ct(e) {
        const {
          ...
          { onClose: d, searchRef: p, searchSpreads: h } = Object(
            m.ensureNotNull,
          )(Object(c.useContext)(Z)),
          {
            setSelectedAction: f,
            ...
            Object.assign({}, u, {
              ...
              onClick: w
                ...
                : function (r) {
                    if (void 0 === l) return;
                    if (void 0 === a)
                      return void Object(m.ensureDefined)(e.onClick)(r);
                    a
                      ? (n('watchlist-widget', l),
                        k('watchlist remove click', r),
                        v === l && g())
                      : (St(
                          () => {
                ...
                void 0 === a || w
                  ...
                  : s.a.createElement(Nt, {
                      ...
                      removeFromWatchlist: function (e) {
                        ...
                        n('watchlist-widget', l),
                          x(e),
                          k('watchlist remove button', e),
                          v === l && g();
                      },
                      findInWatchlist: function (e) {
                        if ((e.stopPropagation(), void 0 === l)) return;
                        o('watchlist-widget', l),
                          d(),
                          k('watchlist goto button');
                      },
                    }),
            }),
          )
        ...
        function k(e, t) {
          let n = e;
          t &&
            Object(Be.modifiersFromEvent)(t) === Be.Modifiers.Shift &&
            (n += ' shift'),
      ...
      function jt(e) {
        ...
        return s.a.createElement(
          ...
          Object.assign({}, a, {
            className: h()(
              It.dialog,
              !y && (E ? It.tabletDialog : It.desktopDialog),
            ),
            ...
            onKeyDown: function (e) {
              ...
              switch (Object(Be.hashFromEvent)(e)) {
                ...
                case 37: {
                  ...
                  if (!n && t && Boolean(r) && d.has(t))
                    return e.preventDefault(), void f(t);
                ...
                case 13:
                  ...
                  C ? I(!1) : b(!1),
                    null === (t = l.current) || void 0 === t || t.select();
                  break;
    ...
    hYF9: function (e, t, n) {
      e.exports = {
        backButton: 'backButton-P2GOgq9R',
    ...
    rzV7: function (e, t, n) {
      ...
      e.exports = function (e, t) {
        ...
        for (var c = 0; c < n.length; c++)
          if (!r.call(t, n[c]) || !o(e[n[c]], t[n[c]])) return !1;
        return !0;
      };
    },
    tCqQ: function (e, t, n) {
          ...
          const {
            ...
            k =
              ...
              ('string' == typeof n
                ...
                : o.cloneElement(n, {
                    className: a(v.icon, n.props.className),
                  }));
          return o.createElement(
            'div',
            Object.assign({}, w, {
      ...
      function i(e) {
        ...
        return r.createElement(
          ...
          r.createElement(
            'span',
            { className: t },
            r.createElement(a.a, { icon: c, className: s.icon }),
          ),
        );
      }
    },
