  ...
  ['floating-toolbars'],
  {
          ...
          n.a.createElement(u.a, {
            ...
            onColorChange: function (t, e) {
              const i = w
                ...
                : 0;
              E(Object(d['generateColor'])(String(t), i, true)),
                e || Object(a.ensureNotNull)(y.current).close();
            },
            onOpacityChange: function (t) {
              E(
                Object(d.generateColor)(
                  w,
                  Object(d.alphaToTransparency)(t),
                  !0,
                ),
              );
            },
    ...
    Ve4Q: function (t, e, i) {
      ...
      function x(t) {
        ...
        const {
          ...
          l =
            null === (e = a.model()) || void 0 === e
              ? void 0
              : e.selection().dataSources();
        return l && l.length
          ? n.a.createElement(
              y.a,
              {
      ...
      function N(t) {
        ...
        return n.a.createElement(
          O.a,
          Object.assign(
            { className: L(e, j.button), tooltipPosition: 'horizontal' },
            i,
          ),
        );
      }
      ...
      function I(t) {
        const { activeChartWidget: e, className: i } = t,
          ...
          s = Object(B.a)(o),
          r = s
            ? { title: Object(a.t)('Unlock'), icon: V }
                        ...
                        o.length > 0 &&
                          t.push(
                            new U.Action({
                              ...
                              icon: i('+KIV'),
                              shortcutHint:
                                A.humanReadableModifiers(D.Modifiers.Mod) +
                                e +
                                ' Drag',
                ...
                ? function (t) {
                    g.contextMenuActionsForSources(d).then((e) => {
                      window.matchMedia(C.a.TabletSmall).matches
                        ? Q.ContextMenuManager.createMenu(X(e), {
                            mode: 'drawer',
                            'data-name': 'more-menu',
                          }).then((e) => e.show(t))
                        : u(X(e));
      ...
      function X(t) {
        return Modernizr.touch && !window.matchMedia('(pointer:fine)').matches
            ...
            _createLinetoolWidget(e) {
              const i = $(
                t.render(
                  ...
                  {
                    icon: l.a[e].icon,
                    isActive: e === a.tool.value(),
                    title: l.a[e].localizedName,
                  },
                ),
              )[0];
              return (
                i.addEventListener('click', (t) => {
                  t.preventDefault(),
                    a.tool.value() !== e && a.tool.setValue(e);
                }),
    ...
    mwqF: function (t, e, i) {
      ...
      function l(t) {
        ...
        return n.createElement(
          'button',
          Object.assign(
            { className: s(b, e), disabled: d, ref: u, tabIndex: _ },
            m,
          ),
    ...
    'p0W+': function (t, e, i) {
      ...
      const l = n.forwardRef((t, e) => {
        ...
        return n.createElement(
          r.b,
          Object.assign({}, l, { ref: e, className: s(i, a.button) }),
        );
      });
    },
    qAO1: function (t, e) {
        ...
        showPropertiesOf(t, e, i) {
          ...
          if (
            ...
            for (var n = {}, s = 0; s < o.length; s++) {
              for (
                var r = o[s], l = e, c = r.name.split('.'), d = 0;
                d < c.length;
                ++d
              )
                l = l && l[c[d]];
        ...
        _defaultToolProperties() {
          return [
            ...
            },
            {
              name: 'linesWidths',
              inputType: 'combobox',
              factory: p.prototype._createWidthsButton,
            },
            {
              name: 'linestyle',
              title: $.t('Style'),
